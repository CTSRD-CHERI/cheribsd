 ...
 */
int caprev_shadow_nomap_set_len(uint64_t * __capability sb, vaddr_t ob,
    size_t len, void * __capability user_obj);

void caprev_shadow_nomap_clear_len(
...
void caprev_shadow_nomap_clear(
    uint64_t * __capability sb, void * __capability obj);
...
void caprev_shadow_nomap_set_raw(
    uint64_t * __capability sb, vaddr_t heap_start, vaddr_t heap_end);

void caprev_shadow_nomap_clear_raw(
    uint64_t * __capability sb, vaddr_t heap_start, vaddr_t heap_end);
