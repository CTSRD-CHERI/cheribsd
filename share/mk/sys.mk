...
#
__TO_CPUARCH=C/mips(n32|64)?(el)?(hf)?(c(128|256))?/mips/:C/arm(v[67])?(eb)?/arm/:C/powerpc(64|64le|spe)/powerpc/:C/riscv64(sf)?c?/riscv/:C/aarch64c/aarch64/
...
LD		?=	ld
LDFLAGS		?=
_LDFLAGS	=	${LDFLAGS:S/-Wl,//g:N-mabi=*:N-march=*:N-fuse-ld=*:N--ld-path=*:N-femulated-tls}
