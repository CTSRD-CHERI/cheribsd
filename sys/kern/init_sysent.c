...
struct sysent sysent[] = {
	...
	{ .sy_narg = AS(cheri_revoke_shadow_args), .sy_call = (sy_call_t *)sys_cheri_revoke_shadow, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 260 = cheri_revoke_shadow */
	{ .sy_narg = AS(cheri_revoke_args), .sy_call = (sy_call_t *)sys_cheri_revoke, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 261 = cheri_revoke */
