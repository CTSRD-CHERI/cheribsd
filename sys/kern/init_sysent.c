...
struct sysent sysent[] = {
	...
	{ AS(caprevoke_shadow_args), (sy_call_t *)sys_caprevoke_shadow, AUE_NULL, NULL, 0, 0, SYF_CAPENABLED, SY_THR_STATIC },	/* 260 = caprevoke_shadow */
	{ AS(caprevoke_args), (sy_call_t *)sys_caprevoke, AUE_NULL, NULL, 0, 0, SYF_CAPENABLED, SY_THR_STATIC },	/* 261 = caprevoke */
