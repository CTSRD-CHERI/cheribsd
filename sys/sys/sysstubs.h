...
SYS_STUB(9, int, link,
    /* _protoargs */ (char *  path, char *  to),
    /* _protoargs_chk */ (int *retp , int * __capability stub_errno, char * __capability   path, char * __capability   to),
    /* _protoargs_err */ (int * __capability stub_errno, char * __capability   path, char * __capability   to),
    /* _callargs */ ((__cheri_fromcap char * )path, (__cheri_fromcap char * )to),
    /* _callargs_chk */ (&ret, stub_errno, path, to),
    /* _callargs_err */ (&errno, (char * )path, (char * )to),
...
SYS_STUB(10, int, unlink,
    /* _protoargs */ (char *  path),
    /* _protoargs_chk */ (int *retp , int * __capability stub_errno, char * __capability   path),
    /* _protoargs_err */ (int * __capability stub_errno, char * __capability   path),
    /* _callargs */ ((__cheri_fromcap char * )path),
    /* _callargs_chk */ (&ret, stub_errno, path),
    /* _callargs_err */ (&errno, (char * )path),
    /* _localcheck */ {if (!(cheri_getperm(path) & CHERI_PERM_GLOBAL)) {errno = EPROT; return ((int)-1);} }
)
...
SYS_STUB(16, int, chown,
    /* _protoargs */ (char *  path, int uid, int gid),
    /* _protoargs_chk */ (int *retp , int * __capability stub_errno, char * __capability   path, int uid, int gid),
    /* _protoargs_err */ (int * __capability stub_errno, char * __capability   path, int uid, int gid),
    /* _callargs */ ((__cheri_fromcap char * )path, uid, gid),
    /* _callargs_chk */ (&ret, stub_errno, path, uid, gid),
    /* _callargs_err */ (&errno, (char * )path, uid, gid),
    /* _localcheck */ {if (!(cheri_getperm(path) & CHERI_PERM_GLOBAL)) {errno = EPROT; return ((int)-1);} }
)
...
SYS_STUB(21, int, mount,
    /* _protoargs */ (char *  type, char *  path, int flags, char *  data),
    /* _protoargs_chk */ (int *retp , int * __capability stub_errno, char * __capability   type, char * __capability   path, int flags, char * __capability   data),
    /* _protoargs_err */ (int * __capability stub_errno, char * __capability   type, char * __capability   path, int flags, char * __capability   data),
    /* _callargs */ ((__cheri_fromcap char * )type, (__cheri_fromcap char * )path, flags, (__cheri_fromcap char * )data),
    /* _callargs_chk */ (&ret, stub_errno, type, path, flags, data),
    /* _callargs_err */ (&errno, (char * )type, (char * )path, flags, (char * )data),
...
SYS_STUB(22, int, unmount,
    /* _protoargs */ (char *  path, int flags),
    /* _protoargs_chk */ (int *retp , int * __capability stub_errno, char * __capability   path, int flags),
    /* _protoargs_err */ (int * __capability stub_errno, char * __capability   path, int flags),
    /* _callargs */ ((__cheri_fromcap char * )path, flags),
    /* _callargs_chk */ (&ret, stub_errno, path, flags),
    /* _callargs_err */ (&errno, (char * )path, flags),
    /* _localcheck */ {if (!(cheri_getperm(path) & CHERI_PERM_GLOBAL)) {errno = EPROT; return ((int)-1);} }
)
...
SYS_STUB(33, int, access,
    ...
    /* _protoargs_err */ (int * __capability stub_errno, char * __capability   path, int amode),
...
SYS_STUB(50, int, setlogin,
    /* _protoargs */ (char *  namebuf),
    /* _protoargs_chk */ (int *retp , int * __capability stub_errno, char * __capability   namebuf),
    /* _protoargs_err */ (int * __capability stub_errno, char * __capability   namebuf),
    /* _callargs */ ((__cheri_fromcap char * )namebuf),
    /* _callargs_chk */ (&ret, stub_errno, namebuf),
    /* _callargs_err */ (&errno, (char * )namebuf),
    /* _localcheck */ {if (!(cheri_getperm(namebuf) & CHERI_PERM_GLOBAL)) {errno = EPROT; return ((int)-1);} }
)
...
SYS_STUB(57, int, symlink,
    /* _protoargs */ (char *  path, char *  link),
    /* _protoargs_chk */ (int *retp , int * __capability stub_errno, char * __capability   path, char * __capability   link),
    /* _protoargs_err */ (int * __capability stub_errno, char * __capability   path, char * __capability   link),
    /* _callargs */ ((__cheri_fromcap char * )path, (__cheri_fromcap char * )link),
    /* _callargs_chk */ (&ret, stub_errno, path, link),
    /* _callargs_err */ (&errno, (char * )path, (char * )link),
...
SYS_STUB(58, ssize_t, readlink,
    /* _protoargs */ (char *  path, char *  buf, size_t count),
    /* _protoargs_chk */ (ssize_t *retp , int * __capability stub_errno, char * __capability   path, char * __capability   buf, size_t count),
    /* _protoargs_err */ (int * __capability stub_errno, char * __capability   path, char * __capability   buf, size_t count),
    /* _callargs */ ((__cheri_fromcap char * )path, (__cheri_fromcap char * )buf, count),
    /* _callargs_chk */ (&ret, stub_errno, path, buf, count),
    /* _callargs_err */ (&errno, (char * )path, (char * )buf, count),
...
SYS_STUB(74, int, mprotect,
    /* _protoargs */ (void *  addr, size_t len, int prot),
    /* _protoargs_chk */ (int *retp , int * __capability stub_errno, void * __capability   addr, size_t len, int prot),
    /* _protoargs_err */ (int * __capability stub_errno, void * __capability   addr, size_t len, int prot),
    /* _callargs */ ((__cheri_fromcap void * )addr, len, prot),
    /* _callargs_chk */ (&ret, stub_errno, addr, len, prot),
    /* _callargs_err */ (&errno, (void * )addr, len, prot),
    /* _localcheck */ {if (!(cheri_getperm(addr) & CHERI_PERM_GLOBAL)) {errno = EPROT; return ((int)-1);} }
)
...
SYS_STUB(83, int, setitimer,
    /* _protoargs */ (u_int which, const struct itimerval *  itv, struct itimerval *  oitv),
    /* _protoargs_chk */ (int *retp , int * __capability stub_errno, u_int which, const struct itimerval * __capability   itv, struct itimerval * __capability   oitv),
    /* _protoargs_err */ (int * __capability stub_errno, u_int which, const struct itimerval * __capability   itv, struct itimerval * __capability   oitv),
...
SYS_STUB(85, int, swapon,
    /* _protoargs */ (char *  name),
    /* _protoargs_chk */ (int *retp , int * __capability stub_errno, char * __capability   name),
    /* _protoargs_err */ (int * __capability stub_errno, char * __capability   name),
    /* _callargs */ ((__cheri_fromcap char * )name),
    /* _callargs_chk */ (&ret, stub_errno, name),
    /* _callargs_err */ (&errno, (char * )name),
    /* _localcheck */ {if (!(cheri_getperm(name) & CHERI_PERM_GLOBAL)) {errno = EPROT; return ((int)-1);} }
)

SYS_STUB(86, int, getitimer,
    /* _protoargs */ (u_int which, struct itimerval *  itv),
    /* _protoargs_chk */ (int *retp , int * __capability stub_errno, u_int which, struct itimerval * __capability   itv),
    /* _protoargs_err */ (int * __capability stub_errno, u_int which, struct itimerval * __capability   itv),
...
SYS_STUB(148, int, quotactl,
    /* _protoargs */ (char *  path, int cmd, int uid, char *  arg),
    /* _protoargs_chk */ (int *retp , int * __capability stub_errno, char * __capability   path, int cmd, int uid, char * __capability   arg),
    /* _protoargs_err */ (int * __capability stub_errno, char * __capability   path, int cmd, int uid, char * __capability   arg),
    /* _callargs */ ((__cheri_fromcap char * )path, cmd, uid, (__cheri_fromcap char * )arg),
    /* _callargs_chk */ (&ret, stub_errno, path, cmd, uid, arg),
    /* _callargs_err */ (&errno, (char * )path, cmd, uid, (char * )arg),
...
SYS_STUB(155, int, nfssvc,
    /* _protoargs */ (int flag, char *  argp),
    /* _protoargs_chk */ (int *retp , int * __capability stub_errno, int flag, char * __capability   argp),
    /* _protoargs_err */ (int * __capability stub_errno, int flag, char * __capability   argp),
    /* _callargs */ (flag, (__cheri_fromcap char * )argp),
    /* _callargs_chk */ (&ret, stub_errno, flag, argp),
    /* _callargs_err */ (&errno, flag, (char * )argp),
    /* _localcheck */ {if (!(cheri_getperm(argp) & CHERI_PERM_GLOBAL)) {errno = EPROT; return ((int)-1);} }
)

SYS_STUB(160, int, lgetfh,
    /* _protoargs */ (char *  fname, struct fhandle *  fhp),
    /* _protoargs_chk */ (int *retp , int * __capability stub_errno, char * __capability   fname, struct fhandle * __capability   fhp),
    /* _protoargs_err */ (int * __capability stub_errno, char * __capability   fname, struct fhandle * __capability   fhp),
    /* _callargs */ ((__cheri_fromcap char * )fname, (__cheri_fromcap struct fhandle * )fhp),
    /* _callargs_chk */ (&ret, stub_errno, fname, fhp),
    /* _callargs_err */ (&errno, (char * )fname, (struct fhandle * )fhp),
...
SYS_STUB(191, int, pathconf,
    /* _protoargs */ (char *  path, int name),
    /* _protoargs_chk */ (int *retp , int * __capability stub_errno, char * __capability   path, int name),
    /* _protoargs_err */ (int * __capability stub_errno, char * __capability   path, int name),
    /* _callargs */ ((__cheri_fromcap char * )path, name),
    /* _callargs_chk */ (&ret, stub_errno, path, name),
    /* _callargs_err */ (&errno, (char * )path, name),
    /* _localcheck */ {if (!(cheri_getperm(path) & CHERI_PERM_GLOBAL)) {errno = EPROT; return ((int)-1);} }
)
...
SYS_STUB(235, int, ktimer_create,
...
SYS_STUB(314, ssize_t, aio_return,
    /* _protoargs */ (struct aiocb *  aiocbp),
...
SYS_STUB(359, ssize_t, aio_waitcomplete,
...
SYS_STUB(384, int, __mac_get_proc,
...
SYS_STUB(385, int, __mac_set_proc,
    /* _protoargs */ (struct mac *  mac_p),
    /* _protoargs_chk */ (int *retp , int * __capability stub_errno, struct mac * __capability   mac_p),
    /* _protoargs_err */ (int * __capability stub_errno, struct mac * __capability   mac_p),
    /* _callargs */ ((__cheri_fromcap struct mac * )mac_p),
...
SYS_STUB(387, int, __mac_get_file,
...
SYS_STUB(389, int, __mac_set_file,
    /* _protoargs */ (const char *  path_p, struct mac *  mac_p),
    /* _protoargs_chk */ (int *retp , int * __capability stub_errno, const char * __capability   path_p, struct mac * __capability   mac_p),
    /* _protoargs_err */ (int * __capability stub_errno, const char * __capability   path_p, struct mac * __capability   mac_p),
    /* _callargs */ ((__cheri_fromcap const char * )path_p, (__cheri_fromcap struct mac * )mac_p),
...
SYS_STUB(409, int, __mac_get_pid,
...
SYS_STUB(410, int, __mac_get_link,
    /* _protoargs */ (const char *  path_p, struct mac *  mac_p),
    /* _protoargs_chk */ (int *retp , int * __capability stub_errno, const char * __capability   path_p, struct mac * __capability   mac_p),
    /* _protoargs_err */ (int * __capability stub_errno, const char * __capability   path_p, struct mac * __capability   mac_p),
    /* _callargs */ ((__cheri_fromcap const char * )path_p, (__cheri_fromcap struct mac * )mac_p),
...
SYS_STUB(411, int, __mac_set_link,
    /* _protoargs */ (const char *  path_p, struct mac *  mac_p),
    /* _protoargs_chk */ (int *retp , int * __capability stub_errno, const char * __capability   path_p, struct mac * __capability   mac_p),
    /* _protoargs_err */ (int * __capability stub_errno, const char * __capability   path_p, struct mac * __capability   mac_p),
    /* _callargs */ ((__cheri_fromcap const char * )path_p, (__cheri_fromcap struct mac * )mac_p),
...
SYS_STUB(489, int, faccessat,
    /* _protoargs */ (int fd, char *  path, int amode, int flag),
    /* _protoargs_chk */ (int *retp , int * __capability stub_errno, int fd, char * __capability   path, int amode, int flag),
    /* _protoargs_err */ (int * __capability stub_errno, int fd, char * __capability   path, int amode, int flag),
    /* _callargs */ (fd, (__cheri_fromcap char * )path, amode, flag),
    /* _callargs_chk */ (&ret, stub_errno, fd, path, amode, flag),
    /* _callargs_err */ (&errno, fd, (char * )path, amode, flag),
    /* _localcheck */ {if (!(cheri_getperm(path) & CHERI_PERM_GLOBAL)) {errno = EPROT; return ((int)-1);} }
)
...
SYS_STUB(491, int, fchownat,
    /* _protoargs */ (int fd, char *  path, uid_t uid, gid_t gid, int flag),
    /* _protoargs_chk */ (int *retp , int * __capability stub_errno, int fd, char * __capability   path, uid_t uid, gid_t gid, int flag),
    /* _protoargs_err */ (int * __capability stub_errno, int fd, char * __capability   path, uid_t uid, gid_t gid, int flag),
    /* _callargs */ (fd, (__cheri_fromcap char * )path, uid, gid, flag),
    /* _callargs_chk */ (&ret, stub_errno, fd, path, uid, gid, flag),
    /* _callargs_err */ (&errno, fd, (char * )path, uid, gid, flag),
    /* _localcheck */ {if (!(cheri_getperm(path) & CHERI_PERM_GLOBAL)) {errno = EPROT; return ((int)-1);} }
)
...
SYS_STUB(502, int, symlinkat,
    /* _protoargs */ (char *  path1, int fd, char *  path2),
    /* _protoargs_chk */ (int *retp , int * __capability stub_errno, char * __capability   path1, int fd, char * __capability   path2),
    /* _protoargs_err */ (int * __capability stub_errno, char * __capability   path1, int fd, char * __capability   path2),
    /* _callargs */ ((__cheri_fromcap char * )path1, fd, (__cheri_fromcap char * )path2),
    /* _callargs_chk */ (&ret, stub_errno, path1, fd, path2),
    /* _callargs_err */ (&errno, (char * )path1, fd, (char * )path2),
    /* _localcheck */ {if (!(cheri_getperm(path1) & CHERI_PERM_GLOBAL)) {errno = EPROT; return ((int)-1);} if (!(cheri_getperm(path2) & CHERI_PERM_GLOBAL)) {errno = EPROT; return ((int)-1);} }
)

SYS_STUB(503, int, unlinkat,
    /* _protoargs */ (int fd, char *  path, int flag),
    /* _protoargs_chk */ (int *retp , int * __capability stub_errno, int fd, char * __capability   path, int flag),
    /* _protoargs_err */ (int * __capability stub_errno, int fd, char * __capability   path, int flag),
    /* _callargs */ (fd, (__cheri_fromcap char * )path, flag),
    /* _callargs_chk */ (&ret, stub_errno, fd, path, flag),
    /* _callargs_err */ (&errno, fd, (char * )path, flag),
    /* _localcheck */ {if (!(cheri_getperm(path) & CHERI_PERM_GLOBAL)) {errno = EPROT; return ((int)-1);} }
)
...
SYS_STUB(555, int, statfs,
    ...
    /* _protoargs_err */ (int * __capability stub_errno, char * __capability   path, struct statfs * __capability   buf),
...
SYS_STUB(560, int, kevent,
    /* _protoargs */ (int fd, struct kevent *  changelist, int nchanges, struct kevent *  eventlist, int nevents, const struct timespec *  timeout),
    /* _protoargs_chk */ (int *retp , int * __capability stub_errno, int fd, struct kevent * __capability   changelist, int nchanges, struct kevent * __capability   eventlist, int nevents, const struct timespec * __capability   timeout),
    /* _protoargs_err */ (int * __capability stub_errno, int fd, struct kevent * __capability   changelist, int nchanges, struct kevent * __capability   eventlist, int nevents, const struct timespec * __capability   timeout),
    /* _callargs */ (fd, (__cheri_fromcap struct kevent * )changelist, nchanges, (__cheri_fromcap struct kevent * )eventlist, nevents, (__cheri_fromcap const struct timespec * )timeout),
    /* _callargs_chk */ (&ret, stub_errno, fd, changelist, nchanges, eventlist, nevents, timeout),
    /* _callargs_err */ (&errno, fd, (struct kevent * )changelist, nchanges, (struct kevent * )eventlist, nevents, (const struct timespec * )timeout),
