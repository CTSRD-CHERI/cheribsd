...
systrace_args(int sysnum, void *params, uint64_t *uarg, int *n_args)
{
	...
	case 120: {
		...
		iarg[a++] = p->fd; /* int */
		uarg[a++] = (intptr_t)p->iovp; /* const struct iovec * __capability */
	...
	case 315: {
		...
		uarg[a++] = (intptr_t)p->aiocbp; /* const struct aiocb * __capability const * __capability */
		iarg[a++] = p->nent; /* int */
	...
	case 345: {
		...
		uarg[a++] = (intptr_t)p->set; /* const sigset_t * __capability */
		uarg[a++] = (intptr_t)p->info; /* struct __siginfo * __capability */
		uarg[a++] = (intptr_t)p->timeout; /* const struct timespec * __capability */
		*n_args = 3;
		break;
	}
	...
	case 573: {
		...
		iarg[a++] = p->cmd; /* int */
		uarg[a++] = (intptr_t)p->ptr; /* void * __capability */
		*n_args = 2;
		break;
	}
	/* __realpathat */
	...
	case 586: {
		...
		iarg[a++] = p->fd; /* int */
		uarg[a++] = (intptr_t)p->curr_value; /* struct itimerspec * __capability */
		*n_args = 2;
		break;
	}
	/* timerfd_settime */
	case 587: {
		...
		iarg[a++] = p->fd; /* int */
		iarg[a++] = p->flags; /* int */
		uarg[a++] = (intptr_t)p->new_value; /* const struct itimerspec * __capability */
		uarg[a++] = (intptr_t)p->old_value; /* struct itimerspec * __capability */
		*n_args = 4;
		break;
	}
	default:
...
systrace_entry_setargdesc(int sysnum, int ndx, char *desc, size_t descsz)
{
	...
	case 315:
		switch (ndx) {
		case 0:
			p = "userland const struct aiocb * __capability const * __capability";
			break;
		case 1:
			p = "int";
			break;
	...
	case 345:
		...
		case 0:
			...
			break;
		case 1:
			p = "userland struct __siginfo * __capability";
			break;
		case 2:
			p = "userland const struct timespec * __capability";
			break;
