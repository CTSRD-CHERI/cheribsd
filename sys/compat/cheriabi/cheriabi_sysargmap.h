...
#define	CHERIABI_SYS_fc_read_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_fc_write_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_cheriabi___fc_open_PTRMASK	(0x0 | 0x1 | 0x2)
#define	CHERIABI_SYS_fc_close_PTRMASK	(0x0)
#define	CHERIABI_SYS_fc_fchdir_PTRMASK	(0x0)
#define	CHERIABI_SYS_fc_recvmsg_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_fc_sendmsg_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_fc_recvfrom_PTRMASK	(0x0 | 0x2 | 0x10 | 0x20)
#define	CHERIABI_SYS___fc_accept_PTRMASK	(0x0 | 0x1 | 0x4 | 0x8)
#define	CHERIABI_SYS_fc_getpeername_PTRMASK	(0x0 | 0x2 | 0x4)
#define	CHERIABI_SYS_fc_getsockname_PTRMASK	(0x0 | 0x2 | 0x4)
#define	CHERIABI_SYS_fc_fchflags_PTRMASK	(0x0)
#define	CHERIABI_SYS___fc_dup_PTRMASK	(0x0 | 0x1)
#define	CHERIABI_SYS_cheriabi_fc_ioctl_PTRMASK	(0x0 | 0x4)
#define	CHERIABI_SYS___fc_dup2_PTRMASK	(0x0 | 0x1)
#define	CHERIABI_SYS___fc_fcntl_PTRMASK	(0x0 | 0x1 | 0x8)
#define	CHERIABI_SYS_fc_fsync_PTRMASK	(0x0)
#define	CHERIABI_SYS___fc_socket_PTRMASK	(0x0 | 0x1)
#define	CHERIABI_SYS_fc_connect_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_fc_bind_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_fc_setsockopt_PTRMASK	(0x0 | 0x8)
#define	CHERIABI_SYS_fc_listen_PTRMASK	(0x0)
#define	CHERIABI_SYS_fc_getsockopt_PTRMASK	(0x0 | 0x8 | 0x10)
#define	CHERIABI_SYS_cheriabi_fc_readv_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_cheriabi_fc_writev_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_fc_fchown_PTRMASK	(0x0)
#define	CHERIABI_SYS_fc_fchmod_PTRMASK	(0x0)
#define	CHERIABI_SYS_fc_flock_PTRMASK	(0x0)
#define	CHERIABI_SYS_fc_sendto_PTRMASK	(0x0 | 0x2 | 0x10)
#define	CHERIABI_SYS_fc_shutdown_PTRMASK	(0x0)
#define	CHERIABI_SYS_fc_socketpair_PTRMASK	(0x0 | 0x8)
#define	CHERIABI_SYS_fc_fpathconf_PTRMASK	(0x0)
#define	CHERIABI_SYS_fc_futimes_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_fc_poll_PTRMASK	(0x0 | 0x1)
#define	CHERIABI_SYS_cheriabi_fc_preadv_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_cheriabi_fc_pwritev_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_cheriabi_fc_aio_cancel_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS___fc_acl_get_fd_PTRMASK	(0x0 | 0x4)
#define	CHERIABI_SYS___fc_acl_set_fd_PTRMASK	(0x0 | 0x4)
#define	CHERIABI_SYS___fc_acl_delete_fd_PTRMASK	(0x0)
#define	CHERIABI_SYS___fc_acl_aclcheck_fd_PTRMASK	(0x0 | 0x4)
#define	CHERIABI_SYS_fc_extattr_set_fd_PTRMASK	(0x0 | 0x4 | 0x8)
#define	CHERIABI_SYS_fc_extattr_get_fd_PTRMASK	(0x0 | 0x4 | 0x8)
#define	CHERIABI_SYS_fc_extattr_delete_fd_PTRMASK	(0x0 | 0x4)
#define	CHERIABI_SYS_cheriabi___fc_mac_get_fd_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_cheriabi___fc_mac_set_fd_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_cheriabi_fc_sendfile_PTRMASK	(0x0 | 0x10 | 0x20)
#define	CHERIABI_SYS_fc_extattr_list_fd_PTRMASK	(0x0 | 0x4)
#define	CHERIABI_SYS___fc_kmq_open_PTRMASK	(0x0 | 0x1 | 0x2 | 0x10)
#define	CHERIABI_SYS_fc_kmq_setattr_PTRMASK	(0x0 | 0x2 | 0x4)
#define	CHERIABI_SYS_fc_kmq_timedreceive_PTRMASK	(0x0 | 0x2 | 0x8 | 0x10)
#define	CHERIABI_SYS_fc_kmq_timedsend_PTRMASK	(0x0 | 0x2 | 0x10)
#define	CHERIABI_SYS_cheriabi_fc_kmq_notify_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_fc_sctp_peeloff_PTRMASK	(0x0)
#define	CHERIABI_SYS_fc_sctp_generic_sendmsg_PTRMASK	(0x0 | 0x2 | 0x8 | 0x20)
#define	CHERIABI_SYS_fc_sctp_generic_sendmsg_iov_PTRMASK	(0x0 | 0x2 | 0x8 | 0x20)
#define	CHERIABI_SYS_fc_sctp_generic_recvmsg_PTRMASK	(0x0 | 0x2 | 0x8 | 0x10 | 0x20 | 0x40)
#define	CHERIABI_SYS_fc_pread_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_fc_pwrite_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_cheriabi_fc_mmap_PTRMASK	(0x0 | 0x1)
#define	CHERIABI_SYS_fc_lseek_PTRMASK	(0x0)
#define	CHERIABI_SYS_fc_ftruncate_PTRMASK	(0x0)
#define	CHERIABI_SYS_fc_faccessat_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_fc_fchmodat_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_fc_fchownat_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_cheriabi_fc_fexecve_PTRMASK	(0x0 | 0x2 | 0x4)
#define	CHERIABI_SYS_fc_futimesat_PTRMASK	(0x0 | 0x2 | 0x4)
#define	CHERIABI_SYS_cheriabi_fc_linkat_PTRMASK	(0x0 | 0x2 | 0x8)
#define	CHERIABI_SYS_fc_mkdirat_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_fc_mkfifoat_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_cheriabi___fc_openat_PTRMASK	(0x0 | 0x1 | 0x4)
#define	CHERIABI_SYS_fc_readlinkat_PTRMASK	(0x0 | 0x2 | 0x4)
#define	CHERIABI_SYS_fc_renameat_PTRMASK	(0x0 | 0x2 | 0x8)
#define	CHERIABI_SYS_fc_symlinkat_PTRMASK	(0x0 | 0x1 | 0x4)
#define	CHERIABI_SYS_cheriabi_fc_unlinkat_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_fc_closefrom_PTRMASK	(0x0)
#define	CHERIABI_SYS___fc_cap_rights_get_PTRMASK	(0x0 | 0x4)
#define	CHERIABI_SYS_fc_pdfork_PTRMASK	(0x0 | 0x1)
#define	CHERIABI_SYS_fc_pdkill_PTRMASK	(0x0)
#define	CHERIABI_SYS_fc_pdgetpid_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_fc_posix_fallocate_PTRMASK	(0x0)
#define	CHERIABI_SYS_fc_posix_fadvise_PTRMASK	(0x0)
#define	CHERIABI_SYS_fc_cap_rights_limit_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_fc_cap_ioctls_limit_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_fc_cap_ioctls_get_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_fc_cap_fcntls_limit_PTRMASK	(0x0)
#define	CHERIABI_SYS_fc_cap_fcntls_get_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_fc_bindat_PTRMASK	(0x0 | 0x4)
#define	CHERIABI_SYS_fc_connectat_PTRMASK	(0x0 | 0x4)
#define	CHERIABI_SYS_fc_chflagsat_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS___fc_accept4_PTRMASK	(0x0 | 0x1 | 0x4 | 0x8)
#define	CHERIABI_SYS_fc_pipe2_PTRMASK	(0x0 | 0x1)
#define	CHERIABI_SYS_fc_ppoll_PTRMASK	(0x0 | 0x1 | 0x4 | 0x8)
#define	CHERIABI_SYS_fc_futimens_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_fc_utimensat_PTRMASK	(0x0 | 0x2 | 0x4)
#define	CHERIABI_SYS_fc_fdatasync_PTRMASK	(0x0)
#define	CHERIABI_SYS_fc_fstat_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_fc_fstatat_PTRMASK	(0x0 | 0x2 | 0x4)
#define	CHERIABI_SYS_fc_getdirentries_PTRMASK	(0x0 | 0x2 | 0x8)
#define	CHERIABI_SYS_fc_fstatfs_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_fc_mknodat_PTRMASK	(0x0 | 0x2)
#define	CHERIABI_SYS_cheriabi_fc_kevent_PTRMASK	(0x0 | 0x2 | 0x8 | 0x20)
