...
_LIBCOMPAT_MAKEVARS=	_OBJTOP TMP CPUFLAGS CFLAGS CXXFLAGS LDFLAGS \
			_MACHINE _MACHINE_ARCH WMAKEENV WMAKEFLAGS WMAKE WORLDTMP
...
# preivious assignments
LIBCOMPATWMAKEFLAGS+=	TARGET=${LIBCOMPAT_MACHINE}
LIBCOMPATWMAKEFLAGS+=	TARGET_ARCH=${LIBCOMPAT_MACHINE_ARCH}
# Add LIBCOMPAT_MACHINE_ARCH so that src.opts.mk can disable things such as SSP
LIBCOMPATWMAKEENV+=	LIBCOMPAT_MACHINE=${LIBCOMPAT_MACHINE}
LIBCOMPATWMAKEENV+=	LIBCOMPAT_MACHINE_ARCH=${LIBCOMPAT_MACHINE_ARCH}
