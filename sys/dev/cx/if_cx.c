...
static int cx_sioctl (struct ifnet *ifp, u_long cmd, caddr_t data)
{
	...
	case CASE_IOC_IFREQ(SIOCADDMULTI): CX_DEBUG2 (d, ("SIOCADDMULTI\n"));     return 0;
	case CASE_IOC_IFREQ(SIOCDELMULTI): CX_DEBUG2 (d, ("SIOCDELMULTI\n"));     return 0;
	case CASE_IOC_IFREQ(SIOCSIFFLAGS): CX_DEBUG2 (d, ("SIOCSIFFLAGS\n"));     break;
	case CASE_IOC_IFREQ(SIOCSIFADDR):  CX_DEBUG2 (d, ("SIOCSIFADDR\n"));      break;
	}
