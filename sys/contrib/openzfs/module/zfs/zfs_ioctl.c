...
history_str_get(zfs_cmd_t *zc)
{
	...
	if (copyinstr((__cheri_tocap const void * __capability)(void *)(uintptr_t)zc->zc_history,
...
get_nvlist(uintptr_t nvl, uint64_t size, int iflag, nvlist_t **nvp)
{
	...
	if ((error = ddi_copyin((void * __capability)(uintptr_t)nvl, packed, size,
	    iflag)) != 0) {
...
put_nvlist(zfs_cmd_t *zc, nvlist_t *nvl)
{
	...
	if (size > zc->zc_nvlist_dst_size) {
		...
		if (ddi_copyout(packed, (__cheri_tocap void * __capability)(void *)(uintptr_t)zc->zc_nvlist_dst,
		    size, zc->zc_iflags) != 0)
...
zfs_ioc_pool_get_history(zfs_cmd_t *zc)
{
	...
	if ((error = spa_history_get(spa, &zc->zc_history_offset,
		...
		error = ddi_copyout(hist_buf,
		    (__cheri_tocap void * __capability)(void *)(uintptr_t)zc->zc_history,
...
zfs_ioc_userspace_many(zfs_cmd_t *zc)
{
	...
	if (error == 0) {
		error = xcopyout(buf,
		    (__cheri_tocap void * __capability)(void *)(uintptr_t)zc->zc_nvlist_dst,
