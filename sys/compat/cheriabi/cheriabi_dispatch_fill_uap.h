...
static fill_uap_fp cheriabi_fill_uap_funcs[CHERIABI_SYS_MAXSYSCALL] = {
	...
	[CHERIABI_SYS_sctp_generic_sendmsg_iov] = (fill_uap_fp)CHERIABI_SYS_sctp_generic_sendmsg_iov_fill_uap,
	[CHERIABI_SYS_sctp_generic_recvmsg] = (fill_uap_fp)CHERIABI_SYS_sctp_generic_recvmsg_fill_uap,
