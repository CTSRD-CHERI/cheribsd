...
const char *syscallnames[] = {
	...
	"kevent",			/* 560 = kevent */
	"fc_read",			/* 561 = fc_read */
	"fc_write",			/* 562 = fc_write */
	"__fc_open",			/* 563 = __fc_open */
	"fc_close",			/* 564 = fc_close */
	"fc_fchdir",			/* 565 = fc_fchdir */
	"fc_recvmsg",			/* 566 = fc_recvmsg */
	"fc_sendmsg",			/* 567 = fc_sendmsg */
	"fc_recvfrom",			/* 568 = fc_recvfrom */
	"__fc_accept",			/* 569 = __fc_accept */
	"fc_getpeername",			/* 570 = fc_getpeername */
	"fc_getsockname",			/* 571 = fc_getsockname */
	"fc_fchflags",			/* 572 = fc_fchflags */
	"__fc_dup",			/* 573 = __fc_dup */
	"fc_ioctl",			/* 574 = fc_ioctl */
	"__fc_dup2",			/* 575 = __fc_dup2 */
	"__fc_fcntl",			/* 576 = __fc_fcntl */
	"fc_fsync",			/* 577 = fc_fsync */
	"__fc_socket",			/* 578 = __fc_socket */
	"fc_connect",			/* 579 = fc_connect */
	"fc_bind",			/* 580 = fc_bind */
	"fc_setsockopt",			/* 581 = fc_setsockopt */
	"fc_listen",			/* 582 = fc_listen */
	"fc_getsockopt",			/* 583 = fc_getsockopt */
	"fc_readv",			/* 584 = fc_readv */
	"fc_writev",			/* 585 = fc_writev */
	"fc_fchown",			/* 586 = fc_fchown */
	"fc_fchmod",			/* 587 = fc_fchmod */
	"fc_flock",			/* 588 = fc_flock */
	"fc_sendto",			/* 589 = fc_sendto */
	"fc_shutdown",			/* 590 = fc_shutdown */
	"fc_socketpair",			/* 591 = fc_socketpair */
	"fc_fpathconf",			/* 592 = fc_fpathconf */
	"fc_futimes",			/* 593 = fc_futimes */
	"fc_poll",			/* 594 = fc_poll */
	"fc_preadv",			/* 595 = fc_preadv */
	"fc_pwritev",			/* 596 = fc_pwritev */
	"fc_aio_cancel",			/* 597 = fc_aio_cancel */
	"__fc_acl_get_fd",			/* 598 = __fc_acl_get_fd */
	"__fc_acl_set_fd",			/* 599 = __fc_acl_set_fd */
	"__fc_acl_delete_fd",			/* 600 = __fc_acl_delete_fd */
	"__fc_acl_aclcheck_fd",			/* 601 = __fc_acl_aclcheck_fd */
	"fc_extattr_set_fd",			/* 602 = fc_extattr_set_fd */
	"fc_extattr_get_fd",			/* 603 = fc_extattr_get_fd */
	"fc_extattr_delete_fd",			/* 604 = fc_extattr_delete_fd */
	"__fc_mac_get_fd",			/* 605 = __fc_mac_get_fd */
	"__fc_mac_set_fd",			/* 606 = __fc_mac_set_fd */
	"fc_sendfile",			/* 607 = fc_sendfile */
	"fc_extattr_list_fd",			/* 608 = fc_extattr_list_fd */
	"__fc_kmq_open",			/* 609 = __fc_kmq_open */
	"fc_kmq_setattr",			/* 610 = fc_kmq_setattr */
	"fc_kmq_timedreceive",			/* 611 = fc_kmq_timedreceive */
	"fc_kmq_timedsend",			/* 612 = fc_kmq_timedsend */
	"fc_kmq_notify",			/* 613 = fc_kmq_notify */
	"fc_sctp_peeloff",			/* 614 = fc_sctp_peeloff */
	"fc_sctp_generic_sendmsg",			/* 615 = fc_sctp_generic_sendmsg */
	"fc_sctp_generic_sendmsg_iov",			/* 616 = fc_sctp_generic_sendmsg_iov */
	"fc_sctp_generic_recvmsg",			/* 617 = fc_sctp_generic_recvmsg */
	"fc_pread",			/* 618 = fc_pread */
	"fc_pwrite",			/* 619 = fc_pwrite */
	"fc_mmap",			/* 620 = fc_mmap */
	"fc_lseek",			/* 621 = fc_lseek */
	"fc_ftruncate",			/* 622 = fc_ftruncate */
	"fc_faccessat",			/* 623 = fc_faccessat */
	"fc_fchmodat",			/* 624 = fc_fchmodat */
	"fc_fchownat",			/* 625 = fc_fchownat */
	"fc_fexecve",			/* 626 = fc_fexecve */
	"fc_futimesat",			/* 627 = fc_futimesat */
	"fc_linkat",			/* 628 = fc_linkat */
	"fc_mkdirat",			/* 629 = fc_mkdirat */
	"fc_mkfifoat",			/* 630 = fc_mkfifoat */
	"__fc_openat",			/* 631 = __fc_openat */
	"fc_readlinkat",			/* 632 = fc_readlinkat */
	"fc_renameat",			/* 633 = fc_renameat */
	"fc_symlinkat",			/* 634 = fc_symlinkat */
	"fc_unlinkat",			/* 635 = fc_unlinkat */
	"fc_closefrom",			/* 636 = fc_closefrom */
	"__fc_cap_rights_get",			/* 637 = __fc_cap_rights_get */
	"fc_pdfork",			/* 638 = fc_pdfork */
	"fc_pdkill",			/* 639 = fc_pdkill */
	"fc_pdgetpid",			/* 640 = fc_pdgetpid */
	"fc_posix_fallocate",			/* 641 = fc_posix_fallocate */
	"fc_posix_fadvise",			/* 642 = fc_posix_fadvise */
	"fc_cap_rights_limit",			/* 643 = fc_cap_rights_limit */
	"fc_cap_ioctls_limit",			/* 644 = fc_cap_ioctls_limit */
	"fc_cap_ioctls_get",			/* 645 = fc_cap_ioctls_get */
	"fc_cap_fcntls_limit",			/* 646 = fc_cap_fcntls_limit */
	"fc_cap_fcntls_get",			/* 647 = fc_cap_fcntls_get */
	"fc_bindat",			/* 648 = fc_bindat */
	"fc_connectat",			/* 649 = fc_connectat */
	"fc_chflagsat",			/* 650 = fc_chflagsat */
	"__fc_accept4",			/* 651 = __fc_accept4 */
	"fc_pipe2",			/* 652 = fc_pipe2 */
	"fc_ppoll",			/* 653 = fc_ppoll */
	"fc_futimens",			/* 654 = fc_futimens */
	"fc_utimensat",			/* 655 = fc_utimensat */
	"fc_fdatasync",			/* 656 = fc_fdatasync */
	"fc_fstat",			/* 657 = fc_fstat */
	"fc_fstatat",			/* 658 = fc_fstatat */
	"fc_getdirentries",			/* 659 = fc_getdirentries */
	"fc_fstatfs",			/* 660 = fc_fstatfs */
	"fc_mknodat",			/* 661 = fc_mknodat */
	"fc_kevent",			/* 662 = fc_kevent */
};
