...
const char *linux_syscallnames[] = {
	...
	"linux_read",			/* 63 = linux_read */
	"linux_write",			/* 64 = linux_write */
	"linux_readv",			/* 65 = linux_readv */
	...
	"linux_getresuid",			/* 148 = linux_getresuid */
	"setresgid",			/* 149 = setresgid */
	"linux_getresgid",			/* 150 = linux_getresgid */
	...
	"linux_getrusage",			/* 165 = linux_getrusage */
	"umask",			/* 166 = umask */
	"linux_prctl",			/* 167 = linux_prctl */
	"linux_getcpu",			/* 168 = linux_getcpu */
	"linux_gettimeofday",			/* 169 = linux_gettimeofday */
	"linux_settimeofday",			/* 170 = linux_settimeofday */
	...
	"linux_mlock",			/* 228 = linux_mlock */
	"linux_munlock",			/* 229 = linux_munlock */
