...
typedef int (__sys_ptrace_t)(int, pid_t, char *, int);
...
typedef int (__sys_cheri_cidcap_alloc_t)(uintptr_t *);
...
typedef int (__sys_kbounce_t)(const void *, void *, size_t, int);
typedef int (__sys_cheri_revoke_get_shadow_t)(int, void *, void *);
typedef void * (__sys_cheri_revoke_t)(int, uint64_t, struct cheri_revoke_syscall_info *);
typedef int (__sys_msetname_t)(void *, size_t, const char *);
...
typedef int (__sys_thr_create_t)(struct __ucontext *, long *, int);
...
int __sys_link(const char * path, const char * to);
...
int __sys_ptrace(int req, pid_t pid, char * addr, int data);
...
int __sys_cheri_cidcap_alloc(uintptr_t * cidp);
...
int __sys_kbounce(const void * src, void * dst, size_t len, int flags);
int __sys_cheri_revoke_get_shadow(int flags, void * arena, void * shadow);
void * __sys_cheri_revoke(int flags, uint64_t start_epoch, struct cheri_revoke_syscall_info * crsi);
int __sys_msetname(void * addr, size_t len, const char * name);
...
int __sys_jail(struct jail * jailp);
...
int __sys_thr_create(struct __ucontext * ctx, long * id, int flags);
