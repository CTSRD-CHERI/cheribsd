...
SYS_STUB(326, int, __getcwd,
    ...
    /* _protoargs_chk */ (int *retp , __capability int *stub_errno, char * __capability  buf, u_int buflen),
    /* _protoargs_err */ (__capability int *stub_errno, char * __capability  buf, u_int buflen),
