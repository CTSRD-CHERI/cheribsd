...
struct sysent freebsd64_sysent[] = {
	...
	{ .sy_narg = AS(freebsd64_accel_malloc_args), .sy_call = (sy_call_t *)freebsd64_accel_malloc, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 584 = freebsd64_accel_malloc */
	{ .sy_narg = AS(freebsd64_accel_demalloc_args), .sy_call = (sy_call_t *)freebsd64_accel_demalloc, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 585 = freebsd64_accel_demalloc */
};
