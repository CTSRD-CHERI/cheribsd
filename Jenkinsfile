...
echo("JOB_NAME='${env.JOB_NAME}', JOB_BASE_NAME='${env.JOB_BASE_NAME}', buildTimestamp=${GlobalVars.buildTimestamp}")
...
def archiveBranches = ['main', 'master', 'dev', 'jenkins-release-metadata']
...
mv -v *.xz metadata.json "artifacts-${suffix}"
