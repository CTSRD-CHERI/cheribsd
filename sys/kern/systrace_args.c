...
systrace_args(int sysnum, void *params, uint64_t *uarg, int *n_args)
{
	...
	/* __fc_open */
	case 563: {
		struct __fc_open_args *p = params;
	...
	/* fc_writev */
	case 585: {
		struct fc_writev_args *p = params;
		iarg[0] = p->fc; /* fc_t */
		uarg[1] = (intptr_t) p->iovp; /* struct iovec * */
		uarg[2] = p->iovcnt; /* u_int */
		*n_args = 3;
	...
	/* fc_preadv */
	case 595: {
		struct fc_preadv_args *p = params;
		iarg[0] = p->fc; /* fc_t */
		uarg[1] = (intptr_t) p->iovp; /* struct iovec * */
		uarg[2] = p->iovcnt; /* u_int */
		iarg[3] = p->offset; /* off_t */
	...
	/* fc_pwritev */
	case 596: {
		struct fc_pwritev_args *p = params;
		iarg[0] = p->fc; /* fc_t */
		uarg[1] = (intptr_t) p->iovp; /* struct iovec * */
		uarg[2] = p->iovcnt; /* u_int */
		iarg[3] = p->offset; /* off_t */
	...
	/* fc_aio_cancel */
	case 597: {
		struct fc_aio_cancel_args *p = params;
		iarg[0] = p->fc; /* fc_t */
		uarg[1] = (intptr_t) p->aiocbp; /* struct aiocb * */
		*n_args = 2;
		break;
	...
	/* __fc_mac_get_fd */
	case 605: {
		struct __fc_mac_get_fd_args *p = params;
		iarg[0] = p->fc; /* fc_t */
	...
	/* __fc_mac_set_fd */
	case 606: {
		struct __fc_mac_set_fd_args *p = params;
		iarg[0] = p->fc; /* fc_t */
		uarg[1] = (intptr_t) p->mac_p; /* struct mac_c * */
		*n_args = 2;
		break;
	...
	/* fc_sendfile */
	case 607: {
		struct fc_sendfile_args *p = params;
		iarg[0] = p->fc; /* fc_t */
		iarg[1] = p->sc; /* fc_t */
		iarg[2] = p->offset; /* off_t */
		uarg[3] = p->nbytes; /* size_t */
	...
	/* fc_kmq_notify */
	case 613: {
		struct fc_kmq_notify_args *p = params;
		iarg[0] = p->mqc; /* fc_t */
		uarg[1] = (intptr_t) p->sigev; /* const struct sigevent * */
		*n_args = 2;
		break;
	...
	/* fc_fexecve */
	case 626: {
		struct fc_fexecve_args *p = params;
		iarg[0] = p->fc; /* fc_t */
		uarg[1] = (intptr_t) p->argv; /* void ** */
		uarg[2] = (intptr_t) p->envv; /* void ** */
		*n_args = 3;
		break;
	}
	/* fc_futimesat */
	...
	/* fc_linkat */
	case 628: {
		struct fc_linkat_args *p = params;
		iarg[0] = p->fc1; /* fc_t */
	...
	/* __fc_openat */
	case 631: {
		struct __fc_openat_args *p = params;
		uarg[0] = (intptr_t) p->newfc; /* fc_t * */
		iarg[1] = p->fc; /* fc_t */
	...
	/* fc_unlinkat */
	case 635: {
		struct fc_unlinkat_args *p = params;
		iarg[0] = p->fc; /* fc_t */
		uarg[1] = (intptr_t) p->path; /* const char * */
		iarg[2] = p->flag; /* int */
		*n_args = 3;
	...
	/* fc_kevent */
	case 662: {
		struct fc_kevent_args *p = params;
		iarg[0] = p->fc; /* fc_t */
