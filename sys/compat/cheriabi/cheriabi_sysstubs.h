...
SYS_STUB_VA(5, int, open, flags,
    ...
    /* _callargs */ ((__cheri_fromcap const char *__capability)path, flags, mode),
...
SYS_STUB(9, int, link,
    ...
    /* _callargs */ ((__cheri_fromcap const char *__capability)path, (__cheri_fromcap const char *__capability)to),
...
SYS_STUB(10, int, unlink,
    ...
    /* _callargs */ ((__cheri_fromcap const char *__capability)path),
...
SYS_STUB(21, int, mount,
    ...
    /* _callargs */ ((__cheri_fromcap const char *__capability)type, (__cheri_fromcap const char *__capability)path, flags, (__cheri_fromcap void *__capability)data),
...
SYS_STUB(50, int, setlogin,
    ...
    /* _callargs */ ((__cheri_fromcap const char *__capability)namebuf),
...
SYS_STUB(59, int, execve,
    ...
    /* _callargs */ ((__cheri_fromcap const char *)fname, (__cheri_fromcap void *__capability *)argv, (__cheri_fromcap void *__capability *)envv),
...
SYS_STUB(148, int, quotactl,
    ...
    /* _callargs */ ((__cheri_fromcap const char *__capability)path, cmd, uid, (__cheri_fromcap void *__capability)arg),
...
SYS_STUB(154, int, nlm_syscall,
    ...
    /* _callargs */ (debug_level, grace_period, addr_count, (__cheri_fromcap void *__capability *)addrs),
...
SYS_STUB(155, int, nfssvc,
    ...
    /* _callargs */ (flag, (__cheri_fromcap void *__capability)argp),
...
SYS_STUB_ARGHASPTRS(255, int, aio_read,
    ...
    /* _callargs */ ((__cheri_fromcap struct aiocb*__capability)aiocbp),
...
SYS_STUB(390, int, kenv,
    ...
    /* _callargs */ (what, (__cheri_fromcap const char *__capability)name, (__cheri_fromcap char *__capability)value, len),
...
SYS_STUB(394, int, mac_syscall,
    ...
    /* _callargs */ ((__cheri_fromcap const char *__capability)policy, call, (__cheri_fromcap void *__capability)arg),
...
SYS_STUB_ARGHASPTRS(415, int, __mac_execve,
    ...
    /* _callargs */ ((__cheri_fromcap char *)fname, (__cheri_fromcap void *__capability *)argv, (__cheri_fromcap void *__capability *)envv, (__cheri_fromcap struct mac*)mac_p),
...
SYS_STUB(446, int, auditon,
    ...
    /* _callargs */ (cmd, (__cheri_fromcap void *__capability)data, length),
...
SYS_STUB_ARGHASPTRS(465, int, aio_fsync,
    ...
    /* _callargs */ (op, (__cheri_fromcap struct aiocb*__capability)aiocbp),
...
SYS_STUB(492, int, fexecve,
    ...
    /* _callargs */ (fd, (__cheri_fromcap void *__capability *)argv, (__cheri_fromcap void *__capability *)envv),
...
SYS_STUB(495, int, linkat,
    ...
    /* _callargs */ (fd1, (__cheri_fromcap const char *__capability)path1, fd2, (__cheri_fromcap const char *__capability)path2, flag),
...
SYS_STUB_VA(499, int, openat, flag,
    ...
    /* _callargs */ (fd, (__cheri_fromcap const char *__capability)path, flag, mode),
...
SYS_STUB(503, int, unlinkat,
    ...
    /* _callargs */ (fd, (__cheri_fromcap const char *__capability)path, flag),
