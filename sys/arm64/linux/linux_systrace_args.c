...
#define	nosys	linux_nosys
	...
	case 5: {
		...
		uarg[2] = (intptr_t) p->value; /* const char * __capability */
	...
	case 11: {
		...
		uarg[0] = (intptr_t) p->path; /* const char * __capability */
		uarg[1] = (intptr_t) p->list; /* const char * __capability */
	...
	case 21: {
		...
		iarg[1] = p->op; /* l_int */
		iarg[2] = p->fd; /* l_int */
		uarg[3] = (intptr_t) p->event; /* struct epoll_event * __capability */
		*n_args = 4;
		break;
	}
	/* linux_epoll_pwait */
	case 22: {
		...
		iarg[0] = p->epfd; /* l_int */
		uarg[1] = (intptr_t) p->events; /* struct epoll_event * __capability */
		iarg[2] = p->maxevents; /* l_int */
		iarg[3] = p->timeout; /* l_int */
		uarg[4] = (intptr_t) p->mask; /* l_sigset_t * __capability */
	...
	case 33: {
		...
		iarg[0] = p->dfd; /* l_int */
		uarg[1] = (intptr_t) p->filename; /* const char * __capability */
		iarg[2] = p->mode; /* l_int */
		iarg[3] = p->dev; /* l_uint */
		*n_args = 4;
		break;
	...
	case 34: {
		...
		iarg[0] = p->dfd; /* l_int */
		uarg[1] = (intptr_t) p->pathname; /* const char * __capability */
	...
	case 36: {
		...
		uarg[0] = (intptr_t) p->oldname; /* const char * __capability */
		iarg[1] = p->newdfd; /* l_int */
		uarg[2] = (intptr_t) p->newname; /* const char * __capability */
		*n_args = 3;
		break;
	}
	/* linux_linkat */
	case 37: {
		...
		uarg[1] = (intptr_t) p->oldname; /* const char * __capability */
		iarg[2] = p->newdfd; /* l_int */
		uarg[3] = (intptr_t) p->newname; /* const char * __capability */
		iarg[4] = p->flag; /* l_int */
		*n_args = 5;
		break;
	}
	...
	case 40: {
		...
		uarg[0] = (intptr_t) p->specialfile; /* char * __capability */
		uarg[1] = (intptr_t) p->dir; /* char * __capability */
		uarg[2] = (intptr_t) p->filesystemtype; /* char * __capability */
		iarg[3] = p->rwflag; /* l_ulong */
		uarg[4] = (intptr_t) p->data; /* void * __capability */
		*n_args = 5;
		break;
	}
	/* linux_pivot_root */
	...
	case 43: {
		...
		uarg[0] = (intptr_t) p->path; /* char * __capability */
		uarg[1] = (intptr_t) p->buf; /* struct l_statfs * __capability */
		*n_args = 2;
		break;
	}
	/* linux_fstatfs */
	...
	case 59: {
		...
		uarg[0] = (intptr_t) p->pipefds; /* l_int * __capability */
		iarg[1] = p->flags; /* l_int */
		*n_args = 2;
		break;
	}
	...
	case 61: {
		...
		iarg[0] = p->fd; /* l_uint */
		uarg[1] = (intptr_t) p->dirent; /* void * __capability */
	...
	case 69: {
		...
		iarg[0] = p->fd; /* l_ulong */
		uarg[1] = (intptr_t) p->vec; /* struct iovec * __capability */
	...
	case 71: {
		...
		iarg[0] = p->out; /* l_int */
		iarg[1] = p->in; /* l_int */
		uarg[2] = (intptr_t) p->offset; /* l_off_t * __capability */
	...
	case 72: {
		...
		iarg[0] = p->nfds; /* l_int */
		uarg[1] = (intptr_t) p->readfds; /* l_fd_set * __capability */
		uarg[2] = (intptr_t) p->writefds; /* l_fd_set * __capability */
		uarg[3] = (intptr_t) p->exceptfds; /* l_fd_set * __capability */
		uarg[4] = (intptr_t) p->tsp; /* struct l_timespec * __capability */
		uarg[5] = (intptr_t) p->sig; /* l_uintcap_t * __capability */
		*n_args = 6;
		break;
	}
	/* linux_ppoll */
	case 73: {
		...
		uarg[2] = (intptr_t) p->tsp; /* struct l_timespec * __capability */
		uarg[3] = (intptr_t) p->sset; /* l_sigset_t * __capability */
	...
	case 76: {
		...
		iarg[0] = p->fd_in; /* int */
		uarg[1] = (intptr_t) p->off_in; /* l_loff_t * __capability */
		iarg[2] = p->fd_out; /* int */
		uarg[3] = (intptr_t) p->off_out; /* l_loff_t * __capability */
	...
	case 79: {
		...
		iarg[0] = p->dfd; /* l_int */
		uarg[1] = (intptr_t) p->pathname; /* char * __capability */
		uarg[2] = (intptr_t) p->statbuf; /* struct l_newstat * __capability */
		iarg[3] = p->flag; /* l_int */
		*n_args = 4;
		break;
	}
	...
	case 80: {
		...
		iarg[0] = p->fd; /* l_uint */
		uarg[1] = (intptr_t) p->buf; /* struct l_newstat * __capability */
		*n_args = 2;
		break;
	}
	/* fsync */
	...
	case 86: {
		...
		iarg[0] = p->fd; /* l_int */
		iarg[1] = p->flags; /* l_int */
		uarg[2] = (intptr_t) p->new_value; /* const struct l_itimerspec * __capability */
		uarg[3] = (intptr_t) p->old_value; /* struct l_itimerspec * __capability */
		*n_args = 4;
		break;
	}
	...
	case 87: {
		...
		iarg[0] = p->fd; /* l_int */
		uarg[1] = (intptr_t) p->old_value; /* struct l_itimerspec * __capability */
		*n_args = 2;
		break;
	}
	/* linux_utimensat */
	case 88: {
		...
		iarg[0] = p->dfd; /* l_int */
		uarg[1] = (intptr_t) p->pathname; /* const char * __capability */
		uarg[2] = (intptr_t) p->times; /* const struct l_timespec * __capability */
	...
	case 90: {
		...
		uarg[0] = (intptr_t) p->hdrp; /* struct l_user_cap_header * __capability */
		uarg[1] = (intptr_t) p->datap; /* struct l_user_cap_data * __capability */
		*n_args = 2;
		break;
	}
	/* linux_capset */
	...
	case 95: {
		...
		iarg[1] = p->id; /* l_pid_t */
		uarg[2] = (intptr_t) p->info; /* l_siginfo_t * __capability */
		iarg[3] = p->options; /* l_int */
		uarg[4] = (intptr_t) p->rusage; /* struct rusage * __capability */
		*n_args = 5;
		break;
	}
	...
	case 96: {
		...
		uarg[0] = (intptr_t) p->tidptr; /* l_int * __capability */
		*n_args = 1;
		break;
	}
	/* linux_unshare */
	...
	case 98: {
		...
		uarg[0] = (intptr_t) p->uaddr; /* void * __capability */
		iarg[1] = p->op; /* int */
		iarg[2] = p->val; /* int */
		uarg[3] = (intptr_t) p->timeout; /* struct l_timespec * __capability */
	...
	case 99: {
		...
		uarg[0] = (intptr_t) p->head; /* struct linux_robust_list_head * __capability */
	...
	case 100: {
		...
		iarg[0] = p->pid; /* l_int */
		uarg[1] = (intptr_t) p->head; /* struct linux_robust_list_head * __capability * __capability */
		uarg[2] = (intptr_t) p->len; /* l_size_t * __capability */
		*n_args = 3;
		break;
	}
	/* linux_nanosleep */
	case 101: {
		...
		uarg[0] = (intptr_t) p->rqtp; /* const struct l_timespec * __capability */
		uarg[1] = (intptr_t) p->rmtp; /* struct l_timespec * __capability */
		*n_args = 2;
		break;
	}
	/* linux_getitimer */
	case 102: {
		...
		uarg[1] = (intptr_t) p->itv; /* struct l_itimerval * __capability */
		*n_args = 2;
		break;
	}
	/* linux_setitimer */
	case 103: {
		...
		iarg[0] = p->which; /* l_int */
		uarg[1] = (intptr_t) p->itv; /* struct l_itimerval * __capability */
		uarg[2] = (intptr_t) p->oitv; /* struct l_itimerval * __capability */
		*n_args = 3;
		break;
	}
	/* linux_kexec_load */
	...
	case 107: {
		...
		uarg[1] = (intptr_t) p->evp; /* struct l_sigevent * __capability */
		uarg[2] = (intptr_t) p->timerid; /* l_timer_t * __capability */
		*n_args = 3;
		break;
	}
	/* linux_timer_gettime */
	case 108: {
		...
		uarg[1] = (intptr_t) p->setting; /* struct l_itimerspec * __capability */
		*n_args = 2;
		break;
	}
	...
	case 110: {
		...
		iarg[0] = p->timerid; /* l_timer_t */
		iarg[1] = p->flags; /* l_int */
		uarg[2] = (intptr_t) p->new; /* const struct l_itimerspec * __capability */
		uarg[3] = (intptr_t) p->old; /* struct l_itimerspec * __capability */
		*n_args = 4;
		break;
	}
	/* linux_timer_delete */
	...
	case 112: {
		...
		uarg[1] = (intptr_t) p->tp; /* struct l_timespec * __capability */
		*n_args = 2;
		break;
	}
	/* linux_clock_gettime */
	...
	case 115: {
		...
		iarg[0] = p->which; /* clockid_t */
		iarg[1] = p->flags; /* l_int */
		uarg[2] = (intptr_t) p->rqtp; /* struct l_timespec * __capability */
		uarg[3] = (intptr_t) p->rmtp; /* struct l_timespec * __capability */
		*n_args = 4;
		break;
	}
	/* linux_syslog */
	...
	case 119: {
		...
		uarg[2] = (intptr_t) p->param; /* struct sched_param * __capability */
		*n_args = 3;
		break;
	}
	...
	case 122: {
		...
		iarg[0] = p->pid; /* l_pid_t */
		iarg[1] = p->len; /* l_uint */
		uarg[2] = (intptr_t) p->user_mask_ptr; /* l_ulong * __capability */
		*n_args = 3;
		break;
	}
	...
	case 127: {
		...
		iarg[0] = p->pid; /* l_pid_t */
		uarg[1] = (intptr_t) p->interval; /* struct l_timespec * __capability */
		*n_args = 2;
		break;
	}
	/* linux_kill */
	...
	case 132: {
		...
		uarg[0] = (intptr_t) p->uss; /* l_stack_t * __capability */
		uarg[1] = (intptr_t) p->uoss; /* l_stack_t * __capability */
		*n_args = 2;
		break;
	}
	/* linux_rt_sigsuspend */
	case 133: {
		...
		uarg[0] = (intptr_t) p->newset; /* l_sigset_t * __capability */
	...
	case 134: {
		...
		iarg[0] = p->sig; /* l_int */
		uarg[1] = (intptr_t) p->act; /* l_sigaction_t * __capability */
		uarg[2] = (intptr_t) p->oact; /* l_sigaction_t * __capability */
	...
	case 135: {
		...
		iarg[0] = p->how; /* l_int */
		uarg[1] = (intptr_t) p->mask; /* l_sigset_t * __capability */
		uarg[2] = (intptr_t) p->omask; /* l_sigset_t * __capability */
		iarg[3] = p->sigsetsize; /* l_size_t */
		*n_args = 4;
		break;
	}
	...
	case 136: {
		...
		uarg[0] = (intptr_t) p->set; /* l_sigset_t * __capability */
		iarg[1] = p->sigsetsize; /* l_size_t */
		*n_args = 2;
		break;
	}
	...
	case 137: {
		...
		uarg[0] = (intptr_t) p->mask; /* l_sigset_t * __capability */
		uarg[1] = (intptr_t) p->ptr; /* l_siginfo_t * __capability */
		uarg[2] = (intptr_t) p->timeout; /* l_timeval * __capability */
		iarg[3] = p->sigsetsize; /* l_size_t */
		*n_args = 4;
		break;
	}
	...
	case 139: {
		...
		uarg[0] = (intptr_t) p->ucp; /* struct l_ucontext * __capability */
		*n_args = 1;
		break;
	}
	/* setpriority */
	...
	case 153: {
		...
		uarg[0] = (intptr_t) p->buf; /* struct l_times_argv * __capability */
		*n_args = 1;
		break;
	}
	/* setpgid */
	...
	case 158: {
		...
		uarg[1] = (intptr_t) p->grouplist; /* l_gid_t * __capability */
		*n_args = 2;
		break;
	}
	/* linux_setgroups */
	...
	case 160: {
		...
		uarg[0] = (intptr_t) p->buf; /* struct l_new_utsname * __capability */
		*n_args = 1;
		break;
	}
	/* linux_sethostname */
	case 161: {
		...
		uarg[0] = (intptr_t) p->hostname; /* char * __capability */
		iarg[1] = p->len; /* l_uint */
		*n_args = 2;
		break;
	}
	...
	case 162: {
		...
		uarg[0] = (intptr_t) p->name; /* char * __capability */
		iarg[1] = p->len; /* l_int */
		*n_args = 2;
		break;
	}
	...
	case 163: {
		...
		uarg[1] = (intptr_t) p->rlim; /* struct l_rlimit * __capability */
		*n_args = 2;
		break;
	}
	/* linux_setrlimit */
	...
	case 167: {
		...
		uarg[1] = (intptr_t) p->arg2; /* l_uintcap_t */
		uarg[2] = (intptr_t) p->arg3; /* l_uintcap_t */
		uarg[3] = (intptr_t) p->arg4; /* l_uintcap_t */
		uarg[4] = (intptr_t) p->arg5; /* l_uintcap_t */
		*n_args = 5;
		break;
	}
	/* linux_getcpu */
	case 168: {
		...
		uarg[0] = (intptr_t) p->cpu; /* l_uint * __capability */
		uarg[1] = (intptr_t) p->node; /* l_uint * __capability */
		uarg[2] = (intptr_t) p->cache; /* void * __capability */
		*n_args = 3;
		break;
	}
	/* gettimeofday */
	case 169: {
		...
		uarg[0] = (intptr_t) p->tp; /* l_timeval * __capability */
	...
	case 170: {
		...
		uarg[0] = (intptr_t) p->tv; /* l_timeval * __capability */
		uarg[1] = (intptr_t) p->tzp; /* struct timezone * __capability */
		*n_args = 2;
		break;
	}
	...
	case 179: {
		...
		uarg[0] = (intptr_t) p->info; /* struct l_sysinfo * __capability */
		*n_args = 1;
		break;
	}
	/* linux_mq_open */
	case 180: {
		...
		iarg[2] = p->mode; /* l_mode_t */
		uarg[3] = (intptr_t) p->attr; /* struct mq_attr * __capability */
		*n_args = 4;
		break;
	}
	/* linux_mq_unlink */
	...
	case 182: {
		...
		uarg[4] = (intptr_t) p->abs_timeout; /* const struct l_timespec * __capability */
		*n_args = 5;
		break;
	}
	...
	case 183: {
		...
		iarg[2] = p->msg_len; /* l_size_t */
		uarg[3] = (intptr_t) p->msg_prio; /* l_uint * __capability */
		uarg[4] = (intptr_t) p->abs_timeout; /* const struct l_timespec * __capability */
		*n_args = 5;
		break;
	}
	...
	case 184: {
		...
		iarg[0] = p->mqd; /* l_mqd_t */
		uarg[1] = (intptr_t) p->abs_timeout; /* const struct l_timespec * __capability */
		*n_args = 2;
		break;
	}
	/* linux_mq_getsetattr */
	...
	case 187: {
		...
		iarg[1] = p->cmd; /* l_int */
		uarg[2] = (intptr_t) p->buf; /* struct l_msqid_ds * __capability */
		*n_args = 3;
		break;
	}
	/* linux_msgrcv */
	case 188: {
		...
		iarg[0] = p->msqid; /* l_int */
		uarg[1] = (intptr_t) p->msgp; /* struct l_msgbuf * __capability */
	...
	case 193: {
		...
		iarg[0] = p->semid; /* l_int */
		uarg[1] = (intptr_t) p->tsops; /* struct sembuf * __capability */
	...
	case 195: {
		...
		iarg[1] = p->cmd; /* l_int */
		uarg[2] = (intptr_t) p->buf; /* struct l_shmid_ds * __capability */
		*n_args = 3;
		break;
	}
	/* linux_shmat */
	case 196: {
		...
		iarg[0] = p->shmid; /* l_int */
		uarg[1] = (intptr_t) p->shmaddr; /* char * __capability */
		iarg[2] = p->shmflg; /* l_int */
		*n_args = 3;
		break;
	}
	...
	case 197: {
		...
		uarg[0] = (intptr_t) p->shmaddr; /* char * __capability */
		*n_args = 1;
		break;
	}
	/* linux_socket */
	...
	case 199: {
		...
		iarg[1] = p->type; /* l_int */
		iarg[2] = p->protocol; /* l_int */
		uarg[3] = (intptr_t) p->rsv; /* l_uintcap_t */
		*n_args = 4;
		break;
	}
	/* linux_bind */
	case 200: {
		...
		iarg[0] = p->s; /* l_int */
		uarg[1] = (intptr_t) p->name; /* l_uintcap_t */
	...
	case 202: {
		...
		iarg[0] = p->s; /* l_int */
		uarg[1] = (intptr_t) p->addr; /* l_uintcap_t */
		uarg[2] = (intptr_t) p->namelen; /* l_uintcap_t */
		*n_args = 3;
		break;
	}
	/* linux_connect */
	...
	case 206: {
		...
		iarg[0] = p->s; /* l_int */
		uarg[1] = (intptr_t) p->msg; /* l_uintcap_t */
		iarg[2] = p->len; /* l_size_t */
		iarg[3] = p->flags; /* l_uint */
		uarg[4] = (intptr_t) p->to; /* l_uintcap_t */
	...
	case 207: {
		...
		iarg[0] = p->s; /* l_int */
		uarg[1] = (intptr_t) p->buf; /* l_uintcap_t */
		iarg[2] = p->len; /* l_size_t */
		iarg[3] = p->flags; /* l_uint */
		uarg[4] = (intptr_t) p->from; /* l_uintcap_t */
		uarg[5] = (intptr_t) p->fromlen; /* l_uintcap_t */
		*n_args = 6;
		break;
	}
	/* linux_setsockopt */
	case 208: {
		...
		uarg[3] = (intptr_t) p->optval; /* l_uintcap_t */
	...
	case 209: {
		...
		iarg[2] = p->optname; /* l_int */
		uarg[3] = (intptr_t) p->optval; /* l_uintcap_t */
		uarg[4] = (intptr_t) p->optlen; /* l_uintcap_t */
		*n_args = 5;
		break;
	}
	/* linux_shutdown */
	...
	case 220: {
		...
		uarg[1] = (intptr_t) p->stack; /* void * __capability */
		uarg[2] = (intptr_t) p->parent_tidptr; /* l_pid_t * __capability */
		uarg[3] = (intptr_t) p->tls; /* void * __capability */
		uarg[4] = (intptr_t) p->child_tidptr; /* l_pid_t * __capability */
		*n_args = 5;
		break;
	}
	/* linux_execve */
	case 221: {
		...
		uarg[0] = (intptr_t) p->path; /* char * __capability */
		uarg[1] = (intptr_t) p->argp; /* char * __capability * __capability */
		uarg[2] = (intptr_t) p->envp; /* char * __capability * __capability */
		*n_args = 3;
		break;
	}
	/* linux_mmap2 */
	...
	case 232: {
		...
		iarg[1] = p->len; /* l_size_t */
		uarg[2] = (intptr_t) p->vec; /* u_char * __capability */
		*n_args = 3;
		break;
	}
	/* linux_madvise */
	...
	case 240: {
		...
		iarg[2] = p->sig; /* l_int */
		uarg[3] = (intptr_t) p->uinfo; /* l_siginfo_t * __capability */
		*n_args = 4;
		break;
	}
	...
	case 243: {
		...
		iarg[0] = p->s; /* l_int */
		uarg[1] = (intptr_t) p->msg; /* struct l_mmsghdr * __capability */
		iarg[2] = p->vlen; /* l_uint */
		iarg[3] = p->flags; /* l_uint */
		uarg[4] = (intptr_t) p->timeout; /* struct l_timespec * __capability */
		*n_args = 5;
		break;
	}
	/* linux_wait4 */
	case 260: {
		...
		iarg[0] = p->pid; /* l_pid_t */
		uarg[1] = (intptr_t) p->status; /* l_int * __capability */
	...
	case 261: {
		...
		uarg[2] = (intptr_t) p->new; /* struct rlimit * __capability */
		uarg[3] = (intptr_t) p->old; /* struct rlimit * __capability */
		*n_args = 4;
		break;
	}
	/* linux_fanotify_init */
	...
	case 264: {
		...
		uarg[1] = (intptr_t) p->name; /* const char * __capability */
		uarg[2] = (intptr_t) p->handle; /* struct l_file_handle * __capability */
		uarg[3] = (intptr_t) p->mnt_id; /* l_int * __capability */
		iarg[4] = p->flags; /* l_int */
		*n_args = 5;
		break;
	}
	...
	case 265: {
		...
		uarg[1] = (intptr_t) p->handle; /* struct l_file_handle * __capability */
		iarg[2] = p->flags; /* l_int */
		*n_args = 3;
		break;
	}
	...
	case 270: {
		...
		iarg[0] = p->pid; /* l_pid_t */
		uarg[1] = (intptr_t) p->lvec; /* const struct iovec * __capability */
		iarg[2] = p->liovcnt; /* l_ulong */
		uarg[3] = (intptr_t) p->rvec; /* const struct iovec * __capability */
	...
	case 273: {
		...
		iarg[0] = p->fd; /* l_int */
		uarg[1] = (intptr_t) p->uargs; /* const char * __capability */
		iarg[2] = p->flags; /* l_int */
		*n_args = 3;
		break;
	}
	...
	case 274: {
		...
		iarg[0] = p->pid; /* l_pid_t */
		uarg[1] = (intptr_t) p->attr; /* void * __capability */
		iarg[2] = p->flags; /* l_uint */
		*n_args = 3;
		break;
	}
	...
	case 277: {
		...
		uarg[2] = (intptr_t) p->uargs; /* const char * __capability */
		*n_args = 3;
		break;
	}
	/* linux_getrandom */
	...
	case 279: {
		...
		uarg[0] = (intptr_t) p->uname_ptr; /* const char * __capability */
		iarg[1] = p->flags; /* l_uint */
		*n_args = 2;
		break;
	}
	...
	case 281: {
		...
		iarg[0] = p->dfd; /* l_int */
		uarg[1] = (intptr_t) p->filename; /* const char * __capability */
		uarg[2] = (intptr_t) p->argv; /* const char * __capability * __capability */
		uarg[3] = (intptr_t) p->envp; /* const char * __capability * __capability */
		iarg[4] = p->flags; /* l_int */
		*n_args = 5;
		break;
	}
	...
	case 286: {
		...
		iarg[0] = p->fd; /* l_ulong */
		uarg[1] = (intptr_t) p->vec; /* const struct iovec * __capability */
		iarg[2] = p->vlen; /* l_ulong */
		iarg[3] = p->pos_l; /* l_ulong */
		iarg[4] = p->pos_h; /* l_ulong */
...
#define	nosys	linux_nosys
	...
	case 21:
		...
		case 2:
			...
			break;
		case 3:
			p = "userland struct epoll_event * __capability";
			break;
		default:
			break;
		};
	...
	case 22:
		...
		case 3:
			...
			break;
		case 4:
			p = "userland l_sigset_t * __capability";
			break;
		case 5:
			p = "l_size_t";
			break;
	...
	case 43:
		...
		case 0:
			...
			break;
		case 1:
			p = "userland struct l_statfs * __capability";
			break;
		default:
			break;
		};
	...
	case 71:
		...
		case 1:
			...
			break;
		case 2:
			p = "userland l_off_t * __capability";
			break;
		case 3:
			p = "l_size_t";
			break;
	...
	case 72:
		...
		case 0:
			...
			break;
		case 1:
			p = "userland l_fd_set * __capability";
			break;
		case 2:
			p = "userland l_fd_set * __capability";
			break;
		case 3:
			...
			break;
		case 4:
			p = "userland struct l_timespec * __capability";
			break;
		case 5:
			p = "userland l_uintcap_t * __capability";
			break;
		default:
			break;
		};
	...
	case 76:
		...
		case 0:
			...
			break;
		case 1:
			p = "userland l_loff_t * __capability";
			break;
		case 2:
			p = "int";
			break;
	...
	case 79:
		...
		case 1:
			...
			break;
		case 2:
			p = "userland struct l_newstat * __capability";
			break;
		case 3:
			p = "l_int";
			break;
	...
	case 86:
		...
		case 1:
			...
			break;
		case 2:
			p = "userland const struct l_itimerspec * __capability";
			break;
		case 3:
			p = "userland struct l_itimerspec * __capability";
			break;
		default:
			break;
		};
	...
	case 88:
		...
		case 1:
			...
			break;
		case 2:
			p = "userland const struct l_timespec * __capability";
			break;
		case 3:
			p = "l_int";
			break;
	...
	case 90:
		switch(ndx) {
		case 0:
			p = "userland struct l_user_cap_header * __capability";
			break;
		case 1:
			p = "userland struct l_user_cap_data * __capability";
			break;
		default:
			break;
		};
	...
	case 95:
		...
		case 1:
			...
			break;
		case 2:
			p = "userland l_siginfo_t * __capability";
			break;
		case 3:
			p = "l_int";
			break;
	...
	case 99:
		switch(ndx) {
		case 0:
			p = "userland struct linux_robust_list_head * __capability";
			break;
		case 1:
			p = "l_size_t";
			break;
	...
	case 100:
		...
		case 0:
			...
			break;
		case 1:
			p = "userland struct linux_robust_list_head * __capability * __capability";
			break;
		case 2:
			p = "userland l_size_t * __capability";
			break;
		default:
			break;
		};
	...
	case 102:
		...
		case 0:
			...
			break;
		case 1:
			p = "userland struct l_itimerval * __capability";
			break;
		default:
			break;
		};
	...
	case 107:
		...
		case 0:
			...
			break;
		case 1:
			p = "userland struct l_sigevent * __capability";
			break;
		case 2:
			p = "userland l_timer_t * __capability";
			break;
		default:
			break;
		};
	...
	case 122:
		...
		case 1:
			...
			break;
		case 2:
			p = "userland l_ulong * __capability";
			break;
		default:
			break;
		};
	...
	case 132:
		switch(ndx) {
		case 0:
			p = "userland l_stack_t * __capability";
			break;
		case 1:
			p = "userland l_stack_t * __capability";
			break;
	...
	case 134:
		...
		case 0:
			...
			break;
		case 1:
			p = "userland l_sigaction_t * __capability";
			break;
		case 2:
			p = "userland l_sigaction_t * __capability";
			break;
	...
	case 137:
		...
		case 1:
			...
			break;
		case 2:
			p = "userland l_timeval * __capability";
			break;
		case 3:
			p = "l_size_t";
			break;
	...
	case 139:
		switch(ndx) {
		case 0:
			p = "userland struct l_ucontext * __capability";
			break;
		default:
			break;
		};
	...
	case 153:
		switch(ndx) {
		case 0:
			p = "userland struct l_times_argv * __capability";
			break;
		default:
			break;
		};
	...
	case 158:
		...
		case 0:
			...
			break;
		case 1:
			p = "userland l_gid_t * __capability";
			break;
		default:
			break;
		};
	...
	case 160:
		switch(ndx) {
		case 0:
			p = "userland struct l_new_utsname * __capability";
			break;
		default:
			break;
		};
	...
	case 163:
		...
		case 0:
			...
			break;
		case 1:
			p = "userland struct l_rlimit * __capability";
			break;
		default:
			break;
		};
	...
	case 168:
		switch(ndx) {
		case 0:
			p = "userland l_uint * __capability";
			break;
		case 1:
			p = "userland l_uint * __capability";
			break;
	...
	case 179:
		switch(ndx) {
		case 0:
			p = "userland struct l_sysinfo * __capability";
			break;
		default:
			break;
		};
	...
	case 187:
		...
		case 1:
			...
			break;
		case 2:
			p = "userland struct l_msqid_ds * __capability";
			break;
		default:
			break;
		};
	...
	case 188:
		...
		case 0:
			...
			break;
		case 1:
			p = "userland struct l_msgbuf * __capability";
			break;
		case 2:
			p = "l_size_t";
			break;
	...
	case 195:
		...
		case 1:
			...
			break;
		case 2:
			p = "userland struct l_shmid_ds * __capability";
			break;
		default:
			break;
		};
	...
	case 220:
		...
		case 1:
			...
			break;
		case 2:
			p = "userland l_pid_t * __capability";
			break;
		case 3:
			p = "userland void * __capability";
			break;
	...
	case 232:
		...
		case 1:
			...
			break;
		case 2:
			p = "userland u_char * __capability";
			break;
		default:
			break;
		};
	...
	case 243:
		...
		case 0:
			...
			break;
		case 1:
			p = "userland struct l_mmsghdr * __capability";
			break;
		case 2:
			p = "l_uint";
			break;
	...
	case 264:
		...
		case 1:
			...
			break;
		case 2:
			p = "userland struct l_file_handle * __capability";
			break;
		case 3:
			p = "userland l_int * __capability";
			break;
	...
	case 270:
		...
		case 0:
			...
			break;
		case 1:
			p = "userland const struct iovec * __capability";
			break;
		case 2:
			p = "l_ulong";
			break;
	...
	case 281:
		...
		case 1:
			...
			break;
		case 2:
			p = "userland const char * __capability * __capability";
			break;
		case 3:
			p = "userland const char * __capability * __capability";
			break;
