...
#define PAD64_REQUIRED
	...
	{ AS(fc_read_args), (sy_call_t *)sys_fc_read, AUE_READ, NULL, 0, 0, 0, SY_THR_STATIC },	/* 561 = fc_read */
	{ AS(fc_write_args), (sy_call_t *)sys_fc_write, AUE_WRITE, NULL, 0, 0, 0, SY_THR_STATIC },	/* 562 = fc_write */
	{ AS(cheriabi___fc_open_args), (sy_call_t *)cheriabi___fc_open, AUE_OPEN_RWTC, NULL, 0, 0, 0, SY_THR_STATIC },	/* 563 = cheriabi___fc_open */
	{ AS(fc_close_args), (sy_call_t *)sys_fc_close, AUE_CLOSE, NULL, 0, 0, 0, SY_THR_STATIC },	/* 564 = fc_close */
	{ AS(fc_fchdir_args), (sy_call_t *)sys_fc_fchdir, AUE_FCHDIR, NULL, 0, 0, 0, SY_THR_STATIC },	/* 565 = fc_fchdir */
	{ AS(fc_recvmsg_args), (sy_call_t *)sys_fc_recvmsg, AUE_RECVMSG, NULL, 0, 0, 0, SY_THR_STATIC },	/* 566 = fc_recvmsg */
	{ AS(fc_sendmsg_args), (sy_call_t *)sys_fc_sendmsg, AUE_SENDMSG, NULL, 0, 0, 0, SY_THR_STATIC },	/* 567 = fc_sendmsg */
	{ AS(fc_recvfrom_args), (sy_call_t *)sys_fc_recvfrom, AUE_RECVFROM, NULL, 0, 0, 0, SY_THR_STATIC },	/* 568 = fc_recvfrom */
	{ AS(__fc_accept_args), (sy_call_t *)sys___fc_accept, AUE_ACCEPT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 569 = __fc_accept */
	{ AS(fc_getpeername_args), (sy_call_t *)sys_fc_getpeername, AUE_GETPEERNAME, NULL, 0, 0, 0, SY_THR_STATIC },	/* 570 = fc_getpeername */
	{ AS(fc_getsockname_args), (sy_call_t *)sys_fc_getsockname, AUE_GETSOCKNAME, NULL, 0, 0, 0, SY_THR_STATIC },	/* 571 = fc_getsockname */
	{ AS(fc_fchflags_args), (sy_call_t *)sys_fc_fchflags, AUE_FCHFLAGS, NULL, 0, 0, 0, SY_THR_STATIC },	/* 572 = fc_fchflags */
	{ AS(__fc_dup_args), (sy_call_t *)sys___fc_dup, AUE_DUP, NULL, 0, 0, 0, SY_THR_STATIC },	/* 573 = __fc_dup */
	{ AS(cheriabi_fc_ioctl_args), (sy_call_t *)cheriabi_fc_ioctl, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 574 = cheriabi_fc_ioctl */
	{ AS(__fc_dup2_args), (sy_call_t *)sys___fc_dup2, AUE_DUP2, NULL, 0, 0, 0, SY_THR_STATIC },	/* 575 = __fc_dup2 */
	{ AS(__fc_fcntl_args), (sy_call_t *)sys___fc_fcntl, AUE_FCNTL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 576 = __fc_fcntl */
	{ AS(fc_fsync_args), (sy_call_t *)sys_fc_fsync, AUE_FSYNC, NULL, 0, 0, 0, SY_THR_STATIC },	/* 577 = fc_fsync */
	{ AS(__fc_socket_args), (sy_call_t *)sys___fc_socket, AUE_SOCKET, NULL, 0, 0, 0, SY_THR_STATIC },	/* 578 = __fc_socket */
	{ AS(fc_connect_args), (sy_call_t *)sys_fc_connect, AUE_CONNECT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 579 = fc_connect */
	{ AS(fc_bind_args), (sy_call_t *)sys_fc_bind, AUE_BIND, NULL, 0, 0, 0, SY_THR_STATIC },	/* 580 = fc_bind */
	{ AS(fc_setsockopt_args), (sy_call_t *)sys_fc_setsockopt, AUE_SETSOCKOPT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 581 = fc_setsockopt */
	{ AS(fc_listen_args), (sy_call_t *)sys_fc_listen, AUE_LISTEN, NULL, 0, 0, 0, SY_THR_STATIC },	/* 582 = fc_listen */
	{ AS(fc_getsockopt_args), (sy_call_t *)sys_fc_getsockopt, AUE_GETSOCKOPT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 583 = fc_getsockopt */
	{ AS(cheriabi_fc_readv_args), (sy_call_t *)cheriabi_fc_readv, AUE_READV, NULL, 0, 0, 0, SY_THR_STATIC },	/* 584 = cheriabi_fc_readv */
	{ AS(cheriabi_fc_writev_args), (sy_call_t *)cheriabi_fc_writev, AUE_WRITEV, NULL, 0, 0, 0, SY_THR_STATIC },	/* 585 = cheriabi_fc_writev */
	{ AS(fc_fchown_args), (sy_call_t *)sys_fc_fchown, AUE_FCHOWN, NULL, 0, 0, 0, SY_THR_STATIC },	/* 586 = fc_fchown */
	{ AS(fc_fchmod_args), (sy_call_t *)sys_fc_fchmod, AUE_FCHMOD, NULL, 0, 0, 0, SY_THR_STATIC },	/* 587 = fc_fchmod */
	{ AS(fc_flock_args), (sy_call_t *)sys_fc_flock, AUE_FLOCK, NULL, 0, 0, 0, SY_THR_STATIC },	/* 588 = fc_flock */
	{ AS(fc_sendto_args), (sy_call_t *)sys_fc_sendto, AUE_SENDTO, NULL, 0, 0, 0, SY_THR_STATIC },	/* 589 = fc_sendto */
	{ AS(fc_shutdown_args), (sy_call_t *)sys_fc_shutdown, AUE_SHUTDOWN, NULL, 0, 0, 0, SY_THR_STATIC },	/* 590 = fc_shutdown */
	{ AS(fc_socketpair_args), (sy_call_t *)sys_fc_socketpair, AUE_SOCKETPAIR, NULL, 0, 0, 0, SY_THR_STATIC },	/* 591 = fc_socketpair */
	{ AS(fc_fpathconf_args), (sy_call_t *)sys_fc_fpathconf, AUE_FPATHCONF, NULL, 0, 0, 0, SY_THR_STATIC },	/* 592 = fc_fpathconf */
	{ AS(fc_futimes_args), (sy_call_t *)sys_fc_futimes, AUE_FUTIMES, NULL, 0, 0, 0, SY_THR_STATIC },	/* 593 = fc_futimes */
	{ AS(fc_poll_args), (sy_call_t *)sys_fc_poll, AUE_POLL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 594 = fc_poll */
	{ AS(cheriabi_fc_preadv_args), (sy_call_t *)cheriabi_fc_preadv, AUE_PREADV, NULL, 0, 0, 0, SY_THR_STATIC },	/* 595 = cheriabi_fc_preadv */
	{ AS(cheriabi_fc_pwritev_args), (sy_call_t *)cheriabi_fc_pwritev, AUE_PWRITEV, NULL, 0, 0, 0, SY_THR_STATIC },	/* 596 = cheriabi_fc_pwritev */
	{ AS(cheriabi_fc_aio_cancel_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 597 = cheriabi_fc_aio_cancel */
	{ AS(__fc_acl_get_fd_args), (sy_call_t *)sys___fc_acl_get_fd, AUE_ACL_GET_FD, NULL, 0, 0, 0, SY_THR_STATIC },	/* 598 = __fc_acl_get_fd */
	{ AS(__fc_acl_set_fd_args), (sy_call_t *)sys___fc_acl_set_fd, AUE_ACL_SET_FD, NULL, 0, 0, 0, SY_THR_STATIC },	/* 599 = __fc_acl_set_fd */
	{ AS(__fc_acl_delete_fd_args), (sy_call_t *)sys___fc_acl_delete_fd, AUE_ACL_DELETE_FD, NULL, 0, 0, 0, SY_THR_STATIC },	/* 600 = __fc_acl_delete_fd */
	{ AS(__fc_acl_aclcheck_fd_args), (sy_call_t *)sys___fc_acl_aclcheck_fd, AUE_ACL_CHECK_FD, NULL, 0, 0, 0, SY_THR_STATIC },	/* 601 = __fc_acl_aclcheck_fd */
	{ AS(fc_extattr_set_fd_args), (sy_call_t *)sys_fc_extattr_set_fd, AUE_EXTATTR_SET_FD, NULL, 0, 0, 0, SY_THR_STATIC },	/* 602 = fc_extattr_set_fd */
	{ AS(fc_extattr_get_fd_args), (sy_call_t *)sys_fc_extattr_get_fd, AUE_EXTATTR_GET_FD, NULL, 0, 0, 0, SY_THR_STATIC },	/* 603 = fc_extattr_get_fd */
	{ AS(fc_extattr_delete_fd_args), (sy_call_t *)sys_fc_extattr_delete_fd, AUE_EXTATTR_DELETE_FD, NULL, 0, 0, 0, SY_THR_STATIC },	/* 604 = fc_extattr_delete_fd */
	{ AS(cheriabi___fc_mac_get_fd_args), (sy_call_t *)cheriabi___fc_mac_get_fd, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 605 = cheriabi___fc_mac_get_fd */
	{ AS(cheriabi___fc_mac_set_fd_args), (sy_call_t *)cheriabi___fc_mac_set_fd, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 606 = cheriabi___fc_mac_set_fd */
	{ AS(cheriabi_fc_sendfile_args), (sy_call_t *)cheriabi_fc_sendfile, AUE_SENDFILE, NULL, 0, 0, 0, SY_THR_STATIC },	/* 607 = cheriabi_fc_sendfile */
	{ AS(fc_extattr_list_fd_args), (sy_call_t *)sys_fc_extattr_list_fd, AUE_EXTATTR_LIST_FD, NULL, 0, 0, 0, SY_THR_STATIC },	/* 608 = fc_extattr_list_fd */
	{ AS(__fc_kmq_open_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 609 = __fc_kmq_open */
	{ AS(fc_kmq_setattr_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 610 = fc_kmq_setattr */
	{ AS(fc_kmq_timedreceive_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 611 = fc_kmq_timedreceive */
	{ AS(fc_kmq_timedsend_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 612 = fc_kmq_timedsend */
	{ AS(cheriabi_fc_kmq_notify_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 613 = cheriabi_fc_kmq_notify */
	{ AS(fc_sctp_peeloff_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 614 = fc_sctp_peeloff */
	{ AS(fc_sctp_generic_sendmsg_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 615 = fc_sctp_generic_sendmsg */
	{ AS(fc_sctp_generic_sendmsg_iov_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 616 = fc_sctp_generic_sendmsg_iov */
	{ AS(fc_sctp_generic_recvmsg_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 617 = fc_sctp_generic_recvmsg */
	{ AS(fc_pread_args), (sy_call_t *)sys_fc_pread, AUE_PREAD, NULL, 0, 0, 0, SY_THR_STATIC },	/* 618 = fc_pread */
	{ AS(fc_pwrite_args), (sy_call_t *)sys_fc_pwrite, AUE_PWRITE, NULL, 0, 0, 0, SY_THR_STATIC },	/* 619 = fc_pwrite */
	{ AS(cheriabi_fc_mmap_args), (sy_call_t *)cheriabi_fc_mmap, AUE_MMAP, NULL, 0, 0, 0, SY_THR_STATIC },	/* 620 = cheriabi_fc_mmap */
	{ AS(fc_lseek_args), (sy_call_t *)sys_fc_lseek, AUE_LSEEK, NULL, 0, 0, 0, SY_THR_STATIC },	/* 621 = fc_lseek */
	{ AS(fc_ftruncate_args), (sy_call_t *)sys_fc_ftruncate, AUE_FTRUNCATE, NULL, 0, 0, 0, SY_THR_STATIC },	/* 622 = fc_ftruncate */
	{ AS(fc_faccessat_args), (sy_call_t *)sys_fc_faccessat, AUE_FACCESSAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 623 = fc_faccessat */
	{ AS(fc_fchmodat_args), (sy_call_t *)sys_fc_fchmodat, AUE_FCHMODAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 624 = fc_fchmodat */
	{ AS(fc_fchownat_args), (sy_call_t *)sys_fc_fchownat, AUE_FCHOWNAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 625 = fc_fchownat */
	{ AS(cheriabi_fc_fexecve_args), (sy_call_t *)cheriabi_fc_fexecve, AUE_FEXECVE, NULL, 0, 0, 0, SY_THR_STATIC },	/* 626 = cheriabi_fc_fexecve */
	{ AS(fc_futimesat_args), (sy_call_t *)sys_fc_futimesat, AUE_FUTIMESAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 627 = fc_futimesat */
	{ AS(cheriabi_fc_linkat_args), (sy_call_t *)cheriabi_fc_linkat, AUE_LINKAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 628 = cheriabi_fc_linkat */
	{ AS(fc_mkdirat_args), (sy_call_t *)sys_fc_mkdirat, AUE_MKDIRAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 629 = fc_mkdirat */
	{ AS(fc_mkfifoat_args), (sy_call_t *)sys_fc_mkfifoat, AUE_MKFIFOAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 630 = fc_mkfifoat */
	{ AS(cheriabi___fc_openat_args), (sy_call_t *)cheriabi___fc_openat, AUE_OPENAT_RWTC, NULL, 0, 0, 0, SY_THR_STATIC },	/* 631 = cheriabi___fc_openat */
	{ AS(fc_readlinkat_args), (sy_call_t *)sys_fc_readlinkat, AUE_READLINKAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 632 = fc_readlinkat */
	{ AS(fc_renameat_args), (sy_call_t *)sys_fc_renameat, AUE_RENAMEAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 633 = fc_renameat */
	{ AS(fc_symlinkat_args), (sy_call_t *)sys_fc_symlinkat, AUE_SYMLINKAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 634 = fc_symlinkat */
	{ AS(cheriabi_fc_unlinkat_args), (sy_call_t *)cheriabi_fc_unlinkat, AUE_UNLINKAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 635 = cheriabi_fc_unlinkat */
	{ AS(fc_closefrom_args), (sy_call_t *)sys_fc_closefrom, AUE_CLOSEFROM, NULL, 0, 0, 0, SY_THR_STATIC },	/* 636 = fc_closefrom */
	{ AS(__fc_cap_rights_get_args), (sy_call_t *)sys___fc_cap_rights_get, AUE_CAP_RIGHTS_GET, NULL, 0, 0, 0, SY_THR_STATIC },	/* 637 = __fc_cap_rights_get */
	{ AS(fc_pdfork_args), (sy_call_t *)sys_fc_pdfork, AUE_PDFORK, NULL, 0, 0, 0, SY_THR_STATIC },	/* 638 = fc_pdfork */
	{ AS(fc_pdkill_args), (sy_call_t *)sys_fc_pdkill, AUE_PDKILL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 639 = fc_pdkill */
	{ AS(fc_pdgetpid_args), (sy_call_t *)sys_fc_pdgetpid, AUE_PDGETPID, NULL, 0, 0, 0, SY_THR_STATIC },	/* 640 = fc_pdgetpid */
	{ AS(fc_posix_fallocate_args), (sy_call_t *)sys_fc_posix_fallocate, AUE_POSIX_FALLOCATE, NULL, 0, 0, 0, SY_THR_STATIC },	/* 641 = fc_posix_fallocate */
	{ AS(fc_posix_fadvise_args), (sy_call_t *)sys_fc_posix_fadvise, AUE_POSIX_FADVISE, NULL, 0, 0, 0, SY_THR_STATIC },	/* 642 = fc_posix_fadvise */
	{ AS(fc_cap_rights_limit_args), (sy_call_t *)sys_fc_cap_rights_limit, AUE_CAP_RIGHTS_LIMIT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 643 = fc_cap_rights_limit */
	{ AS(fc_cap_ioctls_limit_args), (sy_call_t *)sys_fc_cap_ioctls_limit, AUE_CAP_IOCTLS_LIMIT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 644 = fc_cap_ioctls_limit */
	{ AS(fc_cap_ioctls_get_args), (sy_call_t *)sys_fc_cap_ioctls_get, AUE_CAP_IOCTLS_GET, NULL, 0, 0, 0, SY_THR_STATIC },	/* 645 = fc_cap_ioctls_get */
	{ AS(fc_cap_fcntls_limit_args), (sy_call_t *)sys_fc_cap_fcntls_limit, AUE_CAP_FCNTLS_LIMIT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 646 = fc_cap_fcntls_limit */
	{ AS(fc_cap_fcntls_get_args), (sy_call_t *)sys_fc_cap_fcntls_get, AUE_CAP_FCNTLS_GET, NULL, 0, 0, 0, SY_THR_STATIC },	/* 647 = fc_cap_fcntls_get */
	{ AS(fc_bindat_args), (sy_call_t *)sys_fc_bindat, AUE_BINDAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 648 = fc_bindat */
	{ AS(fc_connectat_args), (sy_call_t *)sys_fc_connectat, AUE_CONNECTAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 649 = fc_connectat */
	{ AS(fc_chflagsat_args), (sy_call_t *)sys_fc_chflagsat, AUE_CHFLAGSAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 650 = fc_chflagsat */
	{ AS(__fc_accept4_args), (sy_call_t *)sys___fc_accept4, AUE_ACCEPT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 651 = __fc_accept4 */
	{ AS(fc_pipe2_args), (sy_call_t *)sys_fc_pipe2, AUE_PIPE, NULL, 0, 0, 0, SY_THR_STATIC },	/* 652 = fc_pipe2 */
	{ AS(fc_ppoll_args), (sy_call_t *)sys_fc_ppoll, AUE_POLL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 653 = fc_ppoll */
	{ AS(fc_futimens_args), (sy_call_t *)sys_fc_futimens, AUE_FUTIMES, NULL, 0, 0, 0, SY_THR_STATIC },	/* 654 = fc_futimens */
	{ AS(fc_utimensat_args), (sy_call_t *)sys_fc_utimensat, AUE_FUTIMESAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 655 = fc_utimensat */
	{ AS(fc_fdatasync_args), (sy_call_t *)sys_fc_fdatasync, AUE_FSYNC, NULL, 0, 0, 0, SY_THR_STATIC },	/* 656 = fc_fdatasync */
	{ AS(fc_fstat_args), (sy_call_t *)sys_fc_fstat, AUE_FSTAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 657 = fc_fstat */
	{ AS(fc_fstatat_args), (sy_call_t *)sys_fc_fstatat, AUE_FSTATAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 658 = fc_fstatat */
	{ AS(fc_getdirentries_args), (sy_call_t *)sys_fc_getdirentries, AUE_GETDIRENTRIES, NULL, 0, 0, 0, SY_THR_STATIC },	/* 659 = fc_getdirentries */
	{ AS(fc_fstatfs_args), (sy_call_t *)sys_fc_fstatfs, AUE_FSTATFS, NULL, 0, 0, 0, SY_THR_STATIC },	/* 660 = fc_fstatfs */
	{ AS(fc_mknodat_args), (sy_call_t *)sys_fc_mknodat, AUE_MKNODAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 661 = fc_mknodat */
	{ AS(cheriabi_fc_kevent_args), (sy_call_t *)cheriabi_fc_kevent, AUE_KEVENT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 662 = cheriabi_fc_kevent */
};
