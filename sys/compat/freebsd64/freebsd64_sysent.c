...
struct sysent freebsd64_sysent[] = {
	...
	{ .sy_narg = AS(freebsd64_msetname_args), .sy_call = (sy_call_t *)freebsd64_msetname, .sy_auevent = AUE_MSETNAME, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 262 = freebsd64_msetname */
