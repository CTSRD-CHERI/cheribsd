		       ...
		       vm_map_entry_t entry, vm_offset_t *addr)
{
	...
	if (caprevoke_avoid_faults) {
		 ...
		 * in this object whenever we find something unmapped.  Credit goes
		 * to Edward Napierala for demonstrating that this was viable.
		 *
...
_Static_assert((VM_CAPREVOKE_BM_BASE + VM_CAPREVOKE_PAD_SIZE) <=
		VM_MAXUSER_ADDRESS,
