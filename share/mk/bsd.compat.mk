...
LIB32_MACHINE_CPU=	i686 mmx sse sse2
LIB32WMAKEFLAGS=	\
...
LIB${_LIBCOMPAT}_MACHINE_CPU?=	${MACHINE_CPU}
...
LIB${_LIBCOMPAT}WMAKEENV+=	MACHINE_CPU="${LIB${_LIBCOMPAT}_MACHINE_CPU}"
...
_LIBCOMPAT_MAKEVARS=	_OBJTOP TMP CPUFLAGS CFLAGS CXXFLAGS LDFLAGS \
			_MACHINE _MACHINE_ARCH _MACHINE_CPU _MACHINE_ABI \
