...
desc_kernel_purecap_dbg="Pure-capability ${kernel} debug info"
desc_kernel_nocaprevoke="${kernel} without revocation"
desc_kernel_nocaprevoke_dbg="${kernel} without revocation debug info"
desc_kernel_purecap_nocaprevoke="Pure-capability ${kernel} without revocation"
desc_kernel_purecap_nocaprevoke_dbg="Pure-capability ${kernel} without revocation debug info"
