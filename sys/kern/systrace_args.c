...
systrace_args(int sysnum, void *params, uint64_t *uarg, int *n_args)
{
	...
	case 21: {
		...
		iarg[2] = p->flags; /* int */
		uarg[3] = (__cheri_addr intptr_t) p->data; /* char * __capability */
		*n_args = 4;
		break;
	}
	/* unmount */
	...
	case 28: {
		...
		iarg[0] = p->s; /* int */
		uarg[1] = (__cheri_addr intptr_t) p->msg; /* const struct msghdr * __capability */
		iarg[2] = p->flags; /* int */
		*n_args = 3;
		break;
	}
	...
	case 92: {
		...
		iarg[0] = p->fd; /* int */
		iarg[1] = p->cmd; /* int */
		uarg[2] = (__cheri_addr intptr_t) p->arg; /* intptr_t */
		*n_args = 3;
		break;
	}
	/* select */
	...
	case 148: {
		...
		iarg[1] = p->cmd; /* int */
		iarg[2] = p->uid; /* int */
		uarg[3] = (__cheri_addr intptr_t) p->arg; /* char * __capability */
		*n_args = 4;
		break;
	}
	/* nlm_syscall */
	...
	case 155: {
		...
		iarg[0] = p->flag; /* int */
		uarg[1] = (__cheri_addr intptr_t) p->argp; /* char * __capability */
		*n_args = 2;
		break;
	}
	/* lgetfh */
	...
	case 338: {
		...
		uarg[0] = (__cheri_addr intptr_t) p->jailp; /* struct jail * __capability */
		*n_args = 1;
		break;
	}
	/* nnpfs_syscall */
	...
	case 393: {
		...
		uarg[4] = (__cheri_addr intptr_t) p->hdtr; /* struct sf_hdtr * __capability */
	...
	case 472: {
		...
		iarg[0] = p->sd; /* int */
		uarg[1] = (__cheri_addr intptr_t) p->msg; /* char * __capability */
		iarg[2] = p->mlen; /* int */
	...
	case 532: {
		...
		uarg[5] = (__cheri_addr intptr_t) p->info; /* struct __siginfo * __capability */
		*n_args = 6;
		break;
	}
	/* cap_rights_limit */
