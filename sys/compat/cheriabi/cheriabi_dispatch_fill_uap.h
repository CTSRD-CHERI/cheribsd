...
static fill_uap_fp cheriabi_fill_uap_funcs[CHERIABI_SYS_MAXSYSCALL] = {
	...
	[CHERIABI_SYS_fc_read] = (fill_uap_fp)CHERIABI_SYS_fc_read_fill_uap,
	[CHERIABI_SYS_fc_write] = (fill_uap_fp)CHERIABI_SYS_fc_write_fill_uap,
	[CHERIABI_SYS_cheriabi___fc_open] = (fill_uap_fp)CHERIABI_SYS_cheriabi___fc_open_fill_uap,
	[CHERIABI_SYS_fc_close] = (fill_uap_fp)CHERIABI_SYS_fc_close_fill_uap,
	[CHERIABI_SYS_fc_fchdir] = (fill_uap_fp)CHERIABI_SYS_fc_fchdir_fill_uap,
	[CHERIABI_SYS_fc_recvmsg] = (fill_uap_fp)CHERIABI_SYS_fc_recvmsg_fill_uap,
	[CHERIABI_SYS_fc_sendmsg] = (fill_uap_fp)CHERIABI_SYS_fc_sendmsg_fill_uap,
	[CHERIABI_SYS_fc_recvfrom] = (fill_uap_fp)CHERIABI_SYS_fc_recvfrom_fill_uap,
	[CHERIABI_SYS___fc_accept] = (fill_uap_fp)CHERIABI_SYS___fc_accept_fill_uap,
	[CHERIABI_SYS_fc_getpeername] = (fill_uap_fp)CHERIABI_SYS_fc_getpeername_fill_uap,
	[CHERIABI_SYS_fc_getsockname] = (fill_uap_fp)CHERIABI_SYS_fc_getsockname_fill_uap,
	[CHERIABI_SYS_fc_fchflags] = (fill_uap_fp)CHERIABI_SYS_fc_fchflags_fill_uap,
	[CHERIABI_SYS___fc_dup] = (fill_uap_fp)CHERIABI_SYS___fc_dup_fill_uap,
	[CHERIABI_SYS_cheriabi_fc_ioctl] = (fill_uap_fp)CHERIABI_SYS_cheriabi_fc_ioctl_fill_uap,
	[CHERIABI_SYS___fc_dup2] = (fill_uap_fp)CHERIABI_SYS___fc_dup2_fill_uap,
	[CHERIABI_SYS___fc_fcntl] = (fill_uap_fp)CHERIABI_SYS___fc_fcntl_fill_uap,
	[CHERIABI_SYS_fc_fsync] = (fill_uap_fp)CHERIABI_SYS_fc_fsync_fill_uap,
	[CHERIABI_SYS___fc_socket] = (fill_uap_fp)CHERIABI_SYS___fc_socket_fill_uap,
	[CHERIABI_SYS_fc_connect] = (fill_uap_fp)CHERIABI_SYS_fc_connect_fill_uap,
	[CHERIABI_SYS_fc_bind] = (fill_uap_fp)CHERIABI_SYS_fc_bind_fill_uap,
	[CHERIABI_SYS_fc_setsockopt] = (fill_uap_fp)CHERIABI_SYS_fc_setsockopt_fill_uap,
	[CHERIABI_SYS_fc_listen] = (fill_uap_fp)CHERIABI_SYS_fc_listen_fill_uap,
	[CHERIABI_SYS_fc_getsockopt] = (fill_uap_fp)CHERIABI_SYS_fc_getsockopt_fill_uap,
	[CHERIABI_SYS_cheriabi_fc_readv] = (fill_uap_fp)CHERIABI_SYS_cheriabi_fc_readv_fill_uap,
	[CHERIABI_SYS_cheriabi_fc_writev] = (fill_uap_fp)CHERIABI_SYS_cheriabi_fc_writev_fill_uap,
	[CHERIABI_SYS_fc_fchown] = (fill_uap_fp)CHERIABI_SYS_fc_fchown_fill_uap,
	[CHERIABI_SYS_fc_fchmod] = (fill_uap_fp)CHERIABI_SYS_fc_fchmod_fill_uap,
	[CHERIABI_SYS_fc_flock] = (fill_uap_fp)CHERIABI_SYS_fc_flock_fill_uap,
	[CHERIABI_SYS_fc_sendto] = (fill_uap_fp)CHERIABI_SYS_fc_sendto_fill_uap,
	[CHERIABI_SYS_fc_shutdown] = (fill_uap_fp)CHERIABI_SYS_fc_shutdown_fill_uap,
	[CHERIABI_SYS_fc_socketpair] = (fill_uap_fp)CHERIABI_SYS_fc_socketpair_fill_uap,
	[CHERIABI_SYS_fc_fpathconf] = (fill_uap_fp)CHERIABI_SYS_fc_fpathconf_fill_uap,
	[CHERIABI_SYS_fc_futimes] = (fill_uap_fp)CHERIABI_SYS_fc_futimes_fill_uap,
	[CHERIABI_SYS_fc_poll] = (fill_uap_fp)CHERIABI_SYS_fc_poll_fill_uap,
	[CHERIABI_SYS_cheriabi_fc_preadv] = (fill_uap_fp)CHERIABI_SYS_cheriabi_fc_preadv_fill_uap,
	[CHERIABI_SYS_cheriabi_fc_pwritev] = (fill_uap_fp)CHERIABI_SYS_cheriabi_fc_pwritev_fill_uap,
	[CHERIABI_SYS_cheriabi_fc_aio_cancel] = (fill_uap_fp)CHERIABI_SYS_cheriabi_fc_aio_cancel_fill_uap,
	[CHERIABI_SYS___fc_acl_get_fd] = (fill_uap_fp)CHERIABI_SYS___fc_acl_get_fd_fill_uap,
	[CHERIABI_SYS___fc_acl_set_fd] = (fill_uap_fp)CHERIABI_SYS___fc_acl_set_fd_fill_uap,
	[CHERIABI_SYS___fc_acl_delete_fd] = (fill_uap_fp)CHERIABI_SYS___fc_acl_delete_fd_fill_uap,
	[CHERIABI_SYS___fc_acl_aclcheck_fd] = (fill_uap_fp)CHERIABI_SYS___fc_acl_aclcheck_fd_fill_uap,
	[CHERIABI_SYS_fc_extattr_set_fd] = (fill_uap_fp)CHERIABI_SYS_fc_extattr_set_fd_fill_uap,
	[CHERIABI_SYS_fc_extattr_get_fd] = (fill_uap_fp)CHERIABI_SYS_fc_extattr_get_fd_fill_uap,
	[CHERIABI_SYS_fc_extattr_delete_fd] = (fill_uap_fp)CHERIABI_SYS_fc_extattr_delete_fd_fill_uap,
	[CHERIABI_SYS_cheriabi___fc_mac_get_fd] = (fill_uap_fp)CHERIABI_SYS_cheriabi___fc_mac_get_fd_fill_uap,
	[CHERIABI_SYS_cheriabi___fc_mac_set_fd] = (fill_uap_fp)CHERIABI_SYS_cheriabi___fc_mac_set_fd_fill_uap,
	[CHERIABI_SYS_cheriabi_fc_sendfile] = (fill_uap_fp)CHERIABI_SYS_cheriabi_fc_sendfile_fill_uap,
	[CHERIABI_SYS_fc_extattr_list_fd] = (fill_uap_fp)CHERIABI_SYS_fc_extattr_list_fd_fill_uap,
	[CHERIABI_SYS___fc_kmq_open] = (fill_uap_fp)CHERIABI_SYS___fc_kmq_open_fill_uap,
	[CHERIABI_SYS_fc_kmq_setattr] = (fill_uap_fp)CHERIABI_SYS_fc_kmq_setattr_fill_uap,
	[CHERIABI_SYS_fc_kmq_timedreceive] = (fill_uap_fp)CHERIABI_SYS_fc_kmq_timedreceive_fill_uap,
	[CHERIABI_SYS_fc_kmq_timedsend] = (fill_uap_fp)CHERIABI_SYS_fc_kmq_timedsend_fill_uap,
	[CHERIABI_SYS_cheriabi_fc_kmq_notify] = (fill_uap_fp)CHERIABI_SYS_cheriabi_fc_kmq_notify_fill_uap,
	[CHERIABI_SYS_fc_sctp_peeloff] = (fill_uap_fp)CHERIABI_SYS_fc_sctp_peeloff_fill_uap,
	[CHERIABI_SYS_fc_sctp_generic_sendmsg] = (fill_uap_fp)CHERIABI_SYS_fc_sctp_generic_sendmsg_fill_uap,
	[CHERIABI_SYS_fc_sctp_generic_sendmsg_iov] = (fill_uap_fp)CHERIABI_SYS_fc_sctp_generic_sendmsg_iov_fill_uap,
	[CHERIABI_SYS_fc_sctp_generic_recvmsg] = (fill_uap_fp)CHERIABI_SYS_fc_sctp_generic_recvmsg_fill_uap,
	[CHERIABI_SYS_fc_pread] = (fill_uap_fp)CHERIABI_SYS_fc_pread_fill_uap,
	[CHERIABI_SYS_fc_pwrite] = (fill_uap_fp)CHERIABI_SYS_fc_pwrite_fill_uap,
	[CHERIABI_SYS_cheriabi_fc_mmap] = (fill_uap_fp)CHERIABI_SYS_cheriabi_fc_mmap_fill_uap,
	[CHERIABI_SYS_fc_lseek] = (fill_uap_fp)CHERIABI_SYS_fc_lseek_fill_uap,
	[CHERIABI_SYS_fc_ftruncate] = (fill_uap_fp)CHERIABI_SYS_fc_ftruncate_fill_uap,
	[CHERIABI_SYS_fc_faccessat] = (fill_uap_fp)CHERIABI_SYS_fc_faccessat_fill_uap,
	[CHERIABI_SYS_fc_fchmodat] = (fill_uap_fp)CHERIABI_SYS_fc_fchmodat_fill_uap,
	[CHERIABI_SYS_fc_fchownat] = (fill_uap_fp)CHERIABI_SYS_fc_fchownat_fill_uap,
	[CHERIABI_SYS_cheriabi_fc_fexecve] = (fill_uap_fp)CHERIABI_SYS_cheriabi_fc_fexecve_fill_uap,
	[CHERIABI_SYS_fc_futimesat] = (fill_uap_fp)CHERIABI_SYS_fc_futimesat_fill_uap,
	[CHERIABI_SYS_cheriabi_fc_linkat] = (fill_uap_fp)CHERIABI_SYS_cheriabi_fc_linkat_fill_uap,
	[CHERIABI_SYS_fc_mkdirat] = (fill_uap_fp)CHERIABI_SYS_fc_mkdirat_fill_uap,
	[CHERIABI_SYS_fc_mkfifoat] = (fill_uap_fp)CHERIABI_SYS_fc_mkfifoat_fill_uap,
	[CHERIABI_SYS_cheriabi___fc_openat] = (fill_uap_fp)CHERIABI_SYS_cheriabi___fc_openat_fill_uap,
	[CHERIABI_SYS_fc_readlinkat] = (fill_uap_fp)CHERIABI_SYS_fc_readlinkat_fill_uap,
	[CHERIABI_SYS_fc_renameat] = (fill_uap_fp)CHERIABI_SYS_fc_renameat_fill_uap,
	[CHERIABI_SYS_fc_symlinkat] = (fill_uap_fp)CHERIABI_SYS_fc_symlinkat_fill_uap,
	[CHERIABI_SYS_cheriabi_fc_unlinkat] = (fill_uap_fp)CHERIABI_SYS_cheriabi_fc_unlinkat_fill_uap,
	[CHERIABI_SYS_fc_closefrom] = (fill_uap_fp)CHERIABI_SYS_fc_closefrom_fill_uap,
	[CHERIABI_SYS___fc_cap_rights_get] = (fill_uap_fp)CHERIABI_SYS___fc_cap_rights_get_fill_uap,
	[CHERIABI_SYS_fc_pdfork] = (fill_uap_fp)CHERIABI_SYS_fc_pdfork_fill_uap,
	[CHERIABI_SYS_fc_pdkill] = (fill_uap_fp)CHERIABI_SYS_fc_pdkill_fill_uap,
	[CHERIABI_SYS_fc_pdgetpid] = (fill_uap_fp)CHERIABI_SYS_fc_pdgetpid_fill_uap,
	[CHERIABI_SYS_fc_posix_fallocate] = (fill_uap_fp)CHERIABI_SYS_fc_posix_fallocate_fill_uap,
	[CHERIABI_SYS_fc_posix_fadvise] = (fill_uap_fp)CHERIABI_SYS_fc_posix_fadvise_fill_uap,
	[CHERIABI_SYS_fc_cap_rights_limit] = (fill_uap_fp)CHERIABI_SYS_fc_cap_rights_limit_fill_uap,
	[CHERIABI_SYS_fc_cap_ioctls_limit] = (fill_uap_fp)CHERIABI_SYS_fc_cap_ioctls_limit_fill_uap,
	[CHERIABI_SYS_fc_cap_ioctls_get] = (fill_uap_fp)CHERIABI_SYS_fc_cap_ioctls_get_fill_uap,
	[CHERIABI_SYS_fc_cap_fcntls_limit] = (fill_uap_fp)CHERIABI_SYS_fc_cap_fcntls_limit_fill_uap,
	[CHERIABI_SYS_fc_cap_fcntls_get] = (fill_uap_fp)CHERIABI_SYS_fc_cap_fcntls_get_fill_uap,
	[CHERIABI_SYS_fc_bindat] = (fill_uap_fp)CHERIABI_SYS_fc_bindat_fill_uap,
	[CHERIABI_SYS_fc_connectat] = (fill_uap_fp)CHERIABI_SYS_fc_connectat_fill_uap,
	[CHERIABI_SYS_fc_chflagsat] = (fill_uap_fp)CHERIABI_SYS_fc_chflagsat_fill_uap,
	[CHERIABI_SYS___fc_accept4] = (fill_uap_fp)CHERIABI_SYS___fc_accept4_fill_uap,
	[CHERIABI_SYS_fc_pipe2] = (fill_uap_fp)CHERIABI_SYS_fc_pipe2_fill_uap,
	[CHERIABI_SYS_fc_ppoll] = (fill_uap_fp)CHERIABI_SYS_fc_ppoll_fill_uap,
	[CHERIABI_SYS_fc_futimens] = (fill_uap_fp)CHERIABI_SYS_fc_futimens_fill_uap,
	[CHERIABI_SYS_fc_utimensat] = (fill_uap_fp)CHERIABI_SYS_fc_utimensat_fill_uap,
	[CHERIABI_SYS_fc_fdatasync] = (fill_uap_fp)CHERIABI_SYS_fc_fdatasync_fill_uap,
	[CHERIABI_SYS_fc_fstat] = (fill_uap_fp)CHERIABI_SYS_fc_fstat_fill_uap,
	[CHERIABI_SYS_fc_fstatat] = (fill_uap_fp)CHERIABI_SYS_fc_fstatat_fill_uap,
	[CHERIABI_SYS_fc_getdirentries] = (fill_uap_fp)CHERIABI_SYS_fc_getdirentries_fill_uap,
	[CHERIABI_SYS_fc_fstatfs] = (fill_uap_fp)CHERIABI_SYS_fc_fstatfs_fill_uap,
	[CHERIABI_SYS_fc_mknodat] = (fill_uap_fp)CHERIABI_SYS_fc_mknodat_fill_uap,
	[CHERIABI_SYS_cheriabi_fc_kevent] = (fill_uap_fp)CHERIABI_SYS_cheriabi_fc_kevent_fill_uap,
};
