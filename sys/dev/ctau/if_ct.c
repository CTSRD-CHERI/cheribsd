...
static int ct_sioctl (struct ifnet *ifp, u_long cmd, caddr_t data)
{
	...
	case CASE_IOC_IFREQ(SIOCADDMULTI): CT_DEBUG2 (d, ("SIOCADDMULTI\n"));     return 0;
	case CASE_IOC_IFREQ(SIOCDELMULTI): CT_DEBUG2 (d, ("SIOCDELMULTI\n"));     return 0;
	case CASE_IOC_IFREQ(SIOCSIFFLAGS): CT_DEBUG2 (d, ("SIOCSIFFLAGS\n"));     break;
	case CASE_IOC_IFREQ(SIOCSIFADDR):  CT_DEBUG2 (d, ("SIOCSIFADDR\n"));      break;
	}
