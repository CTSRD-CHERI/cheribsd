...
{ "capability_len", DT_IDENT_FUNC, 0, DIF_SUBR_CAPABILITY_LEN, DT_ATTR_STABCMN,
	DT_VERS_2_0, &dt_idops_func, "uint_t(__uintcap_t)" },
{ "capability_base", DT_IDENT_FUNC, 0, DIF_SUBR_CAPABILITY_BASE,
	DT_ATTR_STABCMN, DT_VERS_2_0, &dt_idops_func, "uint_t(__uintcap_t)" },
{ "capability_offset", DT_IDENT_FUNC, 0, DIF_SUBR_CAPABILITY_OFFSET,
	DT_ATTR_STABCMN, DT_VERS_2_0, &dt_idops_func, "uint_t(__uintcap_t)" },
{ "capability_addr", DT_IDENT_FUNC, 0, DIF_SUBR_CAPABILITY_ADDR,
	DT_ATTR_STABCMN, DT_VERS_2_0, &dt_idops_func, "uint_t(__uintcap_t)" },
