...
SYS_STUB(222, int, semop,
    ...
    /* _protoargs_err */ (int * __capability stub_errno, int semid, struct sembuf * __capability   sops, u_int nsops),
...
SYS_STUB(226, int, msgsnd,
    ...
    /* _protoargs_err */ (int * __capability stub_errno, int msqid, void * __capability   msgp, size_t msgsz, int msgflg),
...
SYS_STUB(231, int, shmget,
    ...
    /* _protoargs_err */ (int * __capability stub_errno, key_t key, int size, int shmflg),
...
SYS_STUB_ARGHASPTRS(532, int, wait6,
    ...
    /* _protoargs_err */ (int * __capability stub_errno, int idtype, id_t id, int * __capability   status, int options, struct __wrusage * __capability   wrusage, struct siginfo* __capability   info),
...
SYS_STUB(544, int, procctl,
    ...
    /* _protoargs_err */ (int * __capability stub_errno, int idtype, id_t id, int com, void * __capability   data),
...
SYS_STUB(564, int, coexecve,
    /* _protoargs */ (pid_t pid, const char *  fname, void *  * __capability argv, void *  * __capability envv),
    /* _protoargs_chk */ (int *retp , int * __capability stub_errno, pid_t pid, const char * __capability   fname, void * __capability   * __capability  __capability argv, void * __capability   * __capability  __capability envv),
    /* _protoargs_err */ (int * __capability stub_errno, pid_t pid, const char * __capability   fname, void * __capability   * __capability  __capability argv, void * __capability   * __capability  __capability envv),
    /* _callargs */ (pid, (__cheri_fromcap const char * )fname, (__cheri_fromcap void *  * __capability)argv, (__cheri_fromcap void *  * __capability)envv),
    /* _callargs_chk */ (&ret, stub_errno, pid, fname, argv, envv),
    /* _callargs_err */ (&errno, pid, (const char * )fname, (void *  * __capability)argv, (void *  * __capability)envv),
